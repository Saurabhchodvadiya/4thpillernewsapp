...
var path = hostName === "localhost" ? hostName + "/4thpillars-dev" : hostName;
let site_url = protocol + "//" + path;
...
if (
  ((function (t, e) {
    ...
    function r(t, e, i) {
      return _e(e)
        ? Ce.grep(t, function (t, s) {
            return !!e.call(t, s, t) !== i;
          })
        : e.nodeType
        ? Ce.grep(t, function (t) {
            return (t === e) !== i;
          })
        : "string" != typeof e
        ? Ce.grep(t, function (t) {
            return pe.call(e, t) > -1 !== i;
          })
        : Ce.filter(e, t, i);
    }
    function a(t, e) {
    ...
    function l(t) {
      var e = {};
      return (
        Ce.each(t.match(He) || [], function (t, i) {
          e[i] = !0;
        }),
        e
      );
    ...
    function f(t) {
      return t.replace(je, "ms-").replace(Fe, p);
    }
    function g() {
    ...
    function v(t, e, i) {
      ...
      if (void 0 === i && 1 === t.nodeType)
        if (
          ((s = "data-" + e.replace(Ye, "-$&").toLowerCase()),
          (i = t.getAttribute(s)),
          "string" == typeof i)
        ) {
          try {
    ...
    function b(t, e, i, s) {
      var n,
        ...
        l = a(),
        h = (i && i[3]) || (Ce.cssNumber[e] ? "" : "px"),
        c =
          t.nodeType &&
          (Ce.cssNumber[e] || ("px" !== h && +l)) &&
          Ke.exec(Ce.css(t, e));
      if (c && c[3] !== h) {
        for (l /= 2, h = h || c[3], c = +l || 1; r--; )
          Ce.style(t, e, c + h),
            ...
            (c /= o);
        (c = 2 * c), Ce.style(t, e, c + h), (i = i || []);
      }
      return (
        i &&
          ((c = +c || +l || 0),
          (n = i[1] ? c + (i[1] + 1) * i[2] : +i[2]),
          s && ((s.unit = h), (s.start = c), (s.end = n))),
        n
      );
    }
    function y(t) {
    ...
    function _(t, e) {
      for (var i, s, n = [], o = 0, r = t.length; r > o; o++)
        (s = t[o]),
          s.style &&
            ((i = s.style.display),
            e
              ? ("none" === i &&
                  ((n[o] = qe.get(s, "display") || null),
                  n[o] || (s.style.display = "")),
                "" === s.style.display && Ze(s) && (n[o] = y(s)))
              : "none" !== i && ((n[o] = "none"), qe.set(s, "display", i)));
      for (o = 0; r > o; o++) null != n[o] && (t[o].style.display = n[o]);
      return t;
    }
    function w(t, e) {
      var i;
      return (
        (i =
          "undefined" != typeof t.getElementsByTagName
            ...
            : []),
        void 0 === e || (e && o(t, e)) ? Ce.merge([t], i) : i
      );
    }
    function x(t, e) {
      for (var i = 0, s = t.length; s > i; i++)
        qe.set(t[i], "globalEval", !e || qe.get(e[i], "globalEval"));
    }
    function k(t, e, i, n, o) {
      for (
        ...
        if (((r = t[f]), r || 0 === r))
          if ("object" === s(r)) Ce.merge(p, r.nodeType ? [r] : r);
          else if (ri.test(r)) {
            for (
              a = a || d.appendChild(e.createElement("div")),
                l = (si.exec(r) || ["", ""])[1].toLowerCase(),
                h = oi[l] || oi._default,
                a.innerHTML = h[1] + Ce.htmlPrefilter(r) + h[2],
                u = h[0];
              u--;
      ...
      for (d.textContent = "", f = 0; (r = p[f++]); )
        if (n && Ce.inArray(r, n) > -1) o && o.push(r);
          ...
          ((c = Qe(r)), (a = w(d.appendChild(r), "script")), c && x(a), i)
        )
          for (u = 0; (r = a[u++]); ) ni.test(r.type || "") && i.push(r);
      return d;
    }
    function C() {
      return !0;
    ...
    function $(t, e, i, s, n, o) {
      ...
      return (
        1 === o &&
          ((r = n),
          (n = function (t) {
            return Ce().off(t), r.apply(this, arguments);
          }),
          (n.guid = r.guid || (r.guid = Ce.guid++))),
        t.each(function () {
          Ce.event.add(this, e, n, s, i);
        })
      );
    }
    function P(t, e, i) {
      return i
        ? (qe.set(t, e, !1),
          Ce.event.add(t, e, {
            ...
            handler: function (t) {
              ...
              if (1 & t.isTrigger && this[e]) {
                if (o.length)
                  (Ce.event.special[e] || {}).delegateType &&
                    t.stopPropagation();
                else if (
                  ((o = ce.call(arguments)),
                  qe.set(this, e, o),
          ...
          void 0)
        : (void 0 === qe.get(t, e) && Ce.event.add(t, e, C), void 0);
    }
    function I(t, e) {
      return o(t, "table") && o(11 !== e.nodeType ? e : e.firstChild, "tr")
        ? Ce(t).children("tbody")[0] || t
        : t;
    }
    function A(t) {
    ...
    function O(t, e) {
      ...
      if (1 === e.nodeType) {
        if (
          qe.hasData(t) &&
          ((o = qe.access(t)), (r = qe.set(e, o)), (h = o.events))
        ) {
          delete r.handle, (r.events = {});
          for (n in h)
            for (i = 0, s = h[n].length; s > i; i++)
              Ce.event.add(e, n, h[n][i]);
        }
        Be.hasData(t) &&
          ((a = Be.access(t)), (l = Ce.extend({}, a)), Be.set(e, l));
      }
    }
    function M(t, e) {
      var i = e.nodeName.toLowerCase();
      "input" === i && ii.test(t.type)
        ? (e.checked = t.checked)
        : ("input" === i || "textarea" === i) &&
    ...
    function N(t, e, s, n) {
      ...
      var o,
        ...
        f = e[0],
        g = _e(f);
      if (g || (d > 1 && "string" == typeof f && !ye.checkClone && di.test(f)))
        return t.each(function (i) {
          var o = t.eq(i);
          g && (e[0] = f.call(this, i, o.html())), N(o, e, s, n);
        });
      if (
        d &&
        ((o = k(e, t[0].ownerDocument, !1, t, n)),
        (r = o.firstChild),
        1 === o.childNodes.length && (o = r),
        r || n)
      ) {
        for (a = Ce.map(w(o, "script"), A), l = a.length; d > u; u++)
          (h = o),
            u !== p &&
              ((h = Ce.clone(h, !0, !0)), l && Ce.merge(a, w(h, "script"))),
            s.call(t[u], h, u);
        if (l)
          for (
            c = a[a.length - 1].ownerDocument, Ce.map(a, E), u = 0;
            l > u;
            u++
          )
            (h = a[u]),
              ni.test(h.type || "") &&
                !qe.access(h, "globalEval") &&
                Ce.contains(c, h) &&
                (h.src && "module" !== (h.type || "").toLowerCase()
                  ...
                  : i(h.textContent.replace(pi, ""), h, c));
      }
      return t;
    }
    function H(t, e, i) {
      for (var s, n = e ? Ce.filter(e, t) : t, o = 0; null != (s = n[o]); o++)
        i || 1 !== s.nodeType || Ce.cleanData(w(s)),
          s.parentNode &&
            (i && Qe(s) && x(w(s, "script")), s.parentNode.removeChild(s));
      return t;
    }
    function z(t, e, i) {
      var s,
    ...
    function W(t) {
      for (var e = t[0].toUpperCase() + t.slice(1), i = vi.length; i--; )
        if (((t = vi[i] + e), t in bi)) return t;
    }
    function j(t) {
      var e = Ce.cssProps[t] || yi[t];
      return e ? e : t in bi ? t : (yi[t] = W(t) || t);
    }
    function F(t, e, i) {
      var s = Ke.exec(e);
    ...
    function R(t, e, i, s, n, o) {
      ...
      for (; 4 > r; r += 2)
        "margin" === i && (l += Ce.css(t, i + Xe[r], !0, n)),
          s
            ? ("content" === i && (l -= Ce.css(t, "padding" + Xe[r], !0, n)),
              "margin" !== i &&
                (l -= Ce.css(t, "border" + Xe[r] + "Width", !0, n)))
            : ((l += Ce.css(t, "padding" + Xe[r], !0, n)),
              "padding" !== i
                ? (l += Ce.css(t, "border" + Xe[r] + "Width", !0, n))
                : (a += Ce.css(t, "border" + Xe[r] + "Width", !0, n)));
      return (
        !s &&
          o >= 0 &&
          (l +=
    ...
    function q(t, e, i) {
      var s = gi(t),
        n = !ye.boxSizingReliable() || i,
        o = n && "border-box" === Ce.css(t, "boxSizing", !1, s),
        r = o,
        a = z(t, e, s),
      ...
      return (
        ((!ye.boxSizingReliable() && o) ||
          "auto" === a ||
          (!parseFloat(a) && "inline" === Ce.css(t, "display", !1, s))) &&
          t.getClientRects().length &&
          ((o = "border-box" === Ce.css(t, "boxSizing", !1, s)),
          (r = l in t),
          r && (a = t[l])),
        (a = parseFloat(a) || 0),
        a + R(t, e, i || (o ? "border" : "content"), r, s, a) + "px"
      );
    }
    function B(t, e, i, s, n) {
      return new B.prototype.init(t, e, i, s, n);
    }
    function U() {
      Ti &&
        (le.hidden === !1 && t.requestAnimationFrame
          ? t.requestAnimationFrame(U)
          : t.setTimeout(U, Ce.fx.interval),
        Ce.fx.tick());
    }
    function Y() {
      return (
    ...
    function V(t, e) {
      ...
      for (e = e ? 1 : 0; 4 > s; s += 2 - e)
        (i = Xe[s]), (n["margin" + i] = n["padding" + i] = t);
      return e && (n.opacity = n.width = t), n;
    }
    function K(t, e, i) {
      for (
        var s,
          n = (Q.tweeners[e] || []).concat(Q.tweeners["*"]),
          o = 0,
          r = n.length;
        r > o;
        o++
    ...
    function X(t, e, i) {
      ...
      for (s in e)
        if (((n = e[s]), Si.test(n))) {
          ...
          p[s] = (m && m[s]) || Ce.style(t, s);
        }
      if (((l = !Ce.isEmptyObject(e)), l || !Ce.isEmptyObject(p))) {
        u &&
          1 === t.nodeType &&
          ((i.overflow = [f.overflow, f.overflowX, f.overflowY]),
          (h = m && m.display),
          null == h && (h = qe.get(t, "display")),
          (c = Ce.css(t, "display")),
          "none" === c &&
            (h
              ? (c = h)
        ...
        for (s in p)
          l ||
            (m
              ...
              : (m = qe.access(t, "fxshow", { display: h })),
            o && (m.hidden = !g),
            g && _([t], !0),
            d.done(function () {
              g || _([t]), qe.remove(t, "fxshow");
              for (s in p) Ce.style(t, s, p[s]);
            })),
            (l = K(g ? m[s] : 0, s, d)),
            s in m ||
              ((m[s] = l.start), g && ((l.end = l.start), (l.start = 0)));
      }
    }
    function G(t, e) {
      var i, s, n, o, r;
      for (i in t)
        if (
          ...
          (n = e[s]),
          (o = t[i]),
          Array.isArray(o) && ((n = o[1]), (o = t[i] = o[0])),
      ...
      var s,
        ...
        l = function () {
          ...
          return (
            ...
            1 > o && l
              ? i
              : (l || a.notifyWith(t, [h, 1, 0]), a.resolveWith(t, [h]), !1)
          );
        },
        h = a.promise({
          elem: t,
        ...
        c = h.props;
      for (G(c, h.opts.specialEasing); r > o; o++)
        if ((s = Q.prefilters[o].call(h, t, c, h.opts)))
          return (
            _e(s.stop) &&
              (Ce._queueHooks(h.elem, h.opts.queue).stop = s.stop.bind(s)),
            s
          );
      return (
        Ce.map(c, K, h),
        _e(h.opts.start) && h.opts.start.call(t, h),
        h
          .progress(h.opts.progress)
          .done(h.opts.done, h.opts.complete)
          .fail(h.opts.fail)
          .always(h.opts.always),
        Ce.fx.timer(Ce.extend(l, { elem: t, anim: h, queue: h.opts.queue })),
        h
      );
    }
    function J(t) {
    ...
    function ee(t, e, i, n) {
      ...
      else for (o in e) ee(t + "[" + o + "]", e[o], i, n);
    }
    function ie(t) {
      return function (e, i) {
    ...
    function se(t, e, i, s) {
      function n(a) {
        ...
        return (
          (o[a] = !0),
          Ce.each(t[a] || [], function (t, a) {
            var h = a(e, i, s);
            return "string" != typeof h || r || o[h]
              ? r
                ? !(l = h)
                : void 0
    ...
    function ne(t, e) {
      var i,
        s,
        n = Ce.ajaxSettings.flatOptions || {};
      for (i in e) void 0 !== e[i] && ((n[i] ? t : s || (s = {}))[i] = e[i]);
      return s && Ce.extend(!0, t, s), t;
    }
    function oe(t, e, i) {
    ...
    function re(t, e, i, s) {
      ...
      for (o = c.shift(); o; )
        if (
          ...
          !l && s && t.dataFilter && (e = t.dataFilter(e, t.dataType)),
          (l = o),
          (o = c.shift()))
        )
          if ("*" === o) o = l;
    ...
    (Ce.fn = Ce.prototype = {
      ...
      each: function (t) {
        return Ce.each(this, t);
      },
      map: function (t) {
        return this.pushStack(
          Ce.map(this, function (e, i) {
            return t.call(e, i, e);
          })
        );
      },
          ...
          if (null != (t = arguments[a]))
            for (e in t)
              (s = t[e]),
                "__proto__" !== e &&
                  r !== s &&
                  (h && s && (Ce.isPlainObject(s) || (n = Array.isArray(s)))
                    ? ((i = r[e]),
                      (o =
                        n && !Array.isArray(i)
                          ? []
                          : n || Ce.isPlainObject(i)
                          ? i
                          : {}),
                      (n = !1),
                      (r[e] = Ce.extend(h, o, s)))
      ...
      Ce.extend({
        ...
        isPlainObject: function (t) {
          var e, i;
          return t && "[object Object]" === ge.call(t)
            ? (e = he(t))
              ? ((i = me.call(e, "constructor") && e.constructor),
                "function" == typeof i && ve.call(i) === be)
              : !0
            : !1;
        },
        ...
        each: function (t, e) {
          var i,
            s = 0;
          if (n(t))
            for (i = t.length; i > s && e.call(t[s], s, t[s]) !== !1; s++);
        ...
        makeArray: function (t, e) {
          ...
          return (
            null != t &&
              (n(Object(t))
                ? Ce.merge(i, "string" == typeof t ? [t] : t)
                : de.call(i, t)),
            i
          );
        },
        inArray: function (t, e, i) {
          return null == e ? -1 : pe.call(e, t, i);
        },
        merge: function (t, e) {
        ...
        grep: function (t, e, i) {
          for (var s, n = [], o = 0, r = t.length, a = !i; r > o; o++)
            (s = !e(t[o], o)), s !== a && n.push(t[o]);
          return n;
        },
        map: function (t, e, i) {
          var s,
    ...
    var Se = (function (t) {
      function e(t, e, i, s) {
        ...
        if (
          !s &&
          ((e ? e.ownerDocument || e : F) !== O && E(e), (e = e || O), N)
        ) {
          if (11 !== f && (l = ye.exec(t)))
            if ((n = l[1])) {
              if (9 === f) {
              ...
              if (
                ...
                return Z.apply(i, e.getElementsByClassName(n)), i;
            }
          if (
            !(
              !x.qsa ||
            ...
            if (((c = t), (d = e), 1 === f && ue.test(t))) {
              for (
                ...
                h[o] = "#" + a + " " + p(h[o]);
              (c = h.join(",")), (d = (_e.test(t) && u(e.parentNode)) || e);
            }
            try {
      ...
      function o(t, e) {
        for (var i = t.split("|"), s = i.length; s--; ) k.attrHandle[i[s]] = e;
      }
      function r(t, e) {
        var i = e && t,
          s =
        ...
        return (
          ...
          s(function (s, r, a, l) {
            var h,
              ...
              p = [],
              f = r.length,
              g = s || m(e || "*", a.nodeType ? [a] : a, []),
              b = !t || (!s && e) ? g : v(g, d, t, a, l),
              y = i ? (o || (s ? t : f || n) ? [] : r) : b;
            if ((i && i(b, y, a, l), n))
              for (h = v(y, p), n(h, [], a, l), c = h.length; c--; )
                (u = h[c]) && (y[p[c]] = !(b[p[c]] = u));
            if (s) {
              if (o || t) {
                if (o) {
      ...
      function y(t) {
        for (
          ...
          if ((i = k.relative[t[a].type])) c = [f(g(c), i)];
          else {
        ...
        var n = i.length > 0,
          ...
          r = function (s, r, a, l, h) {
            ...
            for (
              ...
              if (o && c) {
                for (
                  u = 0, r || c.ownerDocument === O || (E(c), (a = !N));
                  (d = t[u++]);
            ...
            if (((p += f), n && f !== p)) {
              ...
              if (s) {
                if (p > 0) for (; f--; ) g[f] || m[f] || (m[f] = Q.call(l));
                m = v(m);
              }
              Z.apply(l, m),
                h && !s && m.length > 0 && p + i.length > 1 && e.uniqueSort(l);
            }
            return h && ((R = _), (P = b)), g;
          };
        return n ? s(r) : r;
      ...
      var w,
        ...
        ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
        _e = /[+~]/,
        we = new RegExp("\\\\([\\da-f]{1,6}" + se + "?|(" + se + ")|.)", "ig"),
        xe = function (t, e, i) {
          var s = "0x" + e - 65536;
          return s !== s || i
            ? e
      ...
      try {
        Z.apply((G = te.call(F.childNodes)), F.childNodes),
      ...
      (x = e.support = {}),
        (T = e.isXML = function (t) {
          ...
          return !ge.test(e || (i && i.nodeName) || "HTML");
        }),
        (E = e.setDocument = function (t) {
          var e,
            i,
            s = t ? t.ownerDocument || t : F;
          return s !== O && 9 === s.nodeType && s.documentElement
            ? ((O = s),
              (M = O.documentElement),
              (N = !T(O)),
              F !== O &&
              ...
              (x.getElementsByClassName = be.test(O.getElementsByClassName)),
              (x.getById = n(function (t) {
                return (
                  (M.appendChild(t).id = j),
              ...
              (z = []),
              (H = []),
              (x.qsa = be.test(O.querySelectorAll)) &&
                (n(function (t) {
              ...
              (x.matchesSelector = be.test(
                ...
                n(function (t) {
                  (x.disconnectedMatch = L.call(t, "*")),
                    L.call(t, "[s!='']:x"),
                    z.push("!=", re);
                }),
              (H = H.length && new RegExp(H.join("|"))),
              (z = z.length && new RegExp(z.join("|"))),
              (e = be.test(M.compareDocumentPosition)),
              (W =
                e || be.test(M.contains)
                  ? function (t, e) {
                        ...
                        !(
                          ...
                          !(i.contains
                            ...
                            : t.compareDocumentPosition &&
                              16 & t.compareDocumentPosition(s))
                        )
                      );
                    }
                  : function (t, e) {
                    ...
                    return i
                      ...
                      : ((i =
                        ...
                        (!x.sortDetached && e.compareDocumentPosition(t) === i)
                          ? t === O || (t.ownerDocument === F && W(F, t))
                            ? -1
                            : e === O || (e.ownerDocument === F && W(F, e))
                            ? 1
                            : I
                            ? ee(I, t) - ee(I, e)
                            : 0
        ...
        (e.attr = function (t, e) {
          ...
          var i = k.attrHandle[e.toLowerCase()],
            s =
              i && X.call(k.attrHandle, e.toLowerCase()) ? i(t, e, !N) : void 0;
          return void 0 !== s
            ? s
            : x.attributes || !N
            ? t.getAttribute(e)
        ...
        (k = e.selectors = {
                ...
                return null == o
                  ...
                  ? ((o += ""),
                    "=" === i
                      ...
                      ? s && o.indexOf(s) > -1
                      : "$=" === i
                      ? s && o.slice(-s.length) === s
                      : "~=" === i
                      ? (" " + o.replace(ae, " ") + " ").indexOf(s) > -1
                      : "|=" === i
                      ? o === s || o.slice(0, s.length + 1) === s + "-"
                      : !1)
                  : !0;
              };
            },
          ...
          pseudos: {
            ...
            lt: c(function (t, e, i) {
              for (var s = 0 > i ? i + e : i > e ? e : i; --s >= 0; ) t.push(s);
              return t;
            }),
            gt: c(function (t, e, i) {
      ...
      return (
        ...
        (S = e.tokenize = function (t, i) {
          ...
          for (a = t, l = [], h = k.preFilter; a; ) {
            (!s || (n = he.exec(a))) &&
              (n && (a = a.slice(n[0].length) || a), l.push((o = []))),
              (s = !1),
              (n = ce.exec(a)) &&
                ((s = n.shift()),
                o.push({ value: s, type: n[0].replace(le, " ") }),
                (a = a.slice(s.length)));
            for (r in k.filter)
              !(n = fe[r].exec(a)) ||
                (h[r] && !(n = h[r](n))) ||
                ((s = n.shift()),
                o.push({ value: s, type: r, matches: n }),
                (a = a.slice(s.length)));
            if (!s) break;
          }
        ...
        (D = e.compile = function (t, e) {
          ...
          if (!o) {
            for (e || (e = S(t)), i = e.length; i--; )
              (o = y(e[i])), o[j] ? s.push(o) : n.push(o);
            (o = Y(t, _(n, s))), (o.selector = t);
          }
          return o;
        }),
        ($ = e.select = function (t, e, i, s) {
          var n,
            o,
            r,
            a,
          ...
          if (((i = i || []), 1 === c.length)) {
            if (
              ...
              if (
                ((e = (k.find.ID(r.matches[0].replace(we, xe), e) || [])[0]),
                !e)
              )
                return i;
            ...
            for (
              n = fe.needsContext.test(t) ? 0 : o.length;
              ...
              if (
                (l = k.find[a]) &&
                (s = l(
                  r.matches[0].replace(we, xe),
                  (_e.test(o[0].type) && u(e.parentNode)) || e
                ))
              ) {
                if ((o.splice(n, 1), (t = s.length && p(o)), !t))
          ...
          return (
            (h || D(t, c))(
              ...
              !N,
              i,
              !e || (_e.test(t) && u(e.parentNode)) || e
            ),
            i
          );
        }),
        (x.sortStable = j.split("").sort(K).join("") === j),
    ...
    var De = function (t, e, i) {
      ...
      Ie = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
    (Ce.filter = function (t, e, i) {
      var s = e[0];
      return (
        i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === s.nodeType
          ? Ce.find.matchesSelector(s, t)
            ? [s]
            : []
          : Ce.find.matches(
              t,
              Ce.grep(e, function (t) {
                return 1 === t.nodeType;
              })
            )
      );
      ...
      Ce.fn.extend({
        find: function (t) {
          ...
          if ("string" != typeof t)
            return this.pushStack(
              Ce(t).filter(function () {
                for (e = 0; s > e; e++) if (Ce.contains(n[e], this)) return !0;
              })
            );
          for (i = this.pushStack([]), e = 0; s > e; e++) Ce.find(t, n[e], i);
          return s > 1 ? Ce.uniqueSort(i) : i;
        },
        filter: function (t) {
        ...
        is: function (t) {
          return !!r(
            this,
            "string" == typeof t && Pe.test(t) ? Ce(t) : t || [],
            !1
          ).length;
        },
      });
    var Ae,
      Ee = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
      Oe = (Ce.fn.init = function (t, e, i) {
        var s, n;
        if (!t) return this;
        if (((i = i || Ae), "string" == typeof t)) {
          if (
            ((s =
          ...
          if (s[1]) {
            if (
              ((e = e instanceof Ce ? e[0] : e),
              Ce.merge(
                this,
                Ce.parseHTML(
                  s[1],
                  e && e.nodeType ? e.ownerDocument || e : le,
                  !0
                )
              ),
              Ie.test(s[1]) && Ce.isPlainObject(e))
            )
              for (s in e) _e(this[s]) ? this[s](e[s]) : this.attr(s, e[s]);
            return this;
          }
          return (
            (n = le.getElementById(s[2])),
    ...
    Ce.fn.extend({
      has: function (t) {
        ...
        return this.filter(function () {
          for (var t = 0; i > t; t++) if (Ce.contains(this, e[t])) return !0;
        });
      },
          ...
          for (; n > s; s++)
            for (i = this[s]; i && i !== e; i = i.parentNode)
              if (
                ...
                (r
                  ? r.index(i) > -1
                  : 1 === i.nodeType && Ce.find.matchesSelector(i, t))
              ) {
                o.push(i);
                break;
              }
      ...
      index: function (t) {
        return t
          ? "string" == typeof t
            ? pe.call(Ce(t), this[0])
            : pe.call(this, t.jquery ? t[0] : t)
          : this[0] && this[0].parentNode
          ? this.first().prevAll().length
          : -1;
      },
      add: function (t, e) {
        return this.pushStack(Ce.uniqueSort(Ce.merge(this.get(), Ce(t, e))));
      },
      addBack: function (t) {
        return this.add(
      ...
      Ce.each(
        {
          ...
          parents: function (t) {
            return De(t, "parentNode");
          },
          parentsUntil: function (t, e, i) {
            return De(t, "parentNode", i);
          },
          next: function (t) {
          ...
          nextUntil: function (t, e, i) {
            return De(t, "nextSibling", i);
          },
          prevUntil: function (t, e, i) {
            return De(t, "previousSibling", i);
          },
          siblings: function (t) {
          ...
          contents: function (t) {
            return "undefined" != typeof t.contentDocument
              ...
              : (o(t, "template") && (t = t.content || t),
                Ce.merge([], t.childNodes));
          },
        },
        function (t, e) {
          Ce.fn[t] = function (i, s) {
            var n = Ce.map(this, e, i);
            return (
              "Until" !== t.slice(-5) && (s = i),
              s && "string" == typeof s && (n = Ce.filter(s, n)),
              this.length > 1 &&
                (Ne[t] || Ce.uniqueSort(n), Me.test(t) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
    ...
    (Ce.Callbacks = function (t) {
      t = "string" == typeof t ? l(t) : Ce.extend({}, t);
      var e,
        i,
        n,
        o,
        ...
        h = -1,
        c = function () {
          for (o = o || t.once, n = e = !0; a.length; h = -1)
            for (i = a.shift(); ++h < r.length; )
              r[h].apply(i[0], i[1]) === !1 &&
                t.stopOnFalse &&
                ((h = r.length), (i = !1));
        ...
        u = {
          add: function () {
            return (
              r &&
                (i && !e && ((h = r.length - 1), a.push(i)),
                (function n(e) {
                  Ce.each(e, function (e, i) {
                    _e(i)
                      ? (t.unique && u.has(i)) || r.push(i)
                      : i && i.length && "string" !== s(i) && n(i);
                  });
                })(arguments),
                i && !e && c()),
              this
          ...
          remove: function () {
            return (
              Ce.each(arguments, function (t, e) {
                for (var i; (i = Ce.inArray(e, r, i)) > -1; )
                  r.splice(i, 1), h >= i && h--;
              }),
              this
            );
          ...
          has: function (t) {
            return t ? Ce.inArray(t, r) > -1 : r.length > 0;
          },
          empty: function () {
            return r && (r = []), this;
          },
            ...
            n = {
              ...
              pipe: function () {
                ...
                return Ce.Deferred(function (e) {
                  Ce.each(i, function (i, s) {
                    var n = _e(t[s[4]]) && t[s[4]];
                    o[s[1]](function () {
              ...
              then: function (e, s, n) {
                      ...
                      u = function () {
                        ...
                        if (!(r > e)) {
                          ...
                          (u =
                            ...
                            _e(u)
                              ? n
                                ? u.call(t, o(r, i, h, n), o(r, i, c, n))
                                : (r++,
                                  u.call(
                                    t,
                                    o(r, i, h, n),
                                    o(r, i, c, n),
                                    o(r, i, h, i.notifyWith)
                                  ))
                              : (s !== h && ((a = void 0), (l = [t])),
                                (n || i.resolveWith)(a, l));
                        }
                        ...
                        : function () {
                            try {
                              ...
                              Ce.Deferred.exceptionHook &&
                                Ce.Deferred.exceptionHook(t, d.stackTrace),
                                e + 1 >= r &&
                                  (s !== c && ((a = void 0), (l = [t])),
                                  i.rejectWith(a, l));
                            }
                ...
                return Ce.Deferred(function (t) {
                  i[0][3].add(o(0, t, _e(n) ? n : h, t.notifyWith)),
                    i[1][3].add(o(0, t, _e(e) ? e : h)),
                    i[2][3].add(o(0, t, _e(s) ? s : c));
                }).promise();
              },
              promise: function (t) {
        ...
        when: function (t) {
          var e = arguments.length,
            ...
            r = function (t) {
              return function (i) {
                (s[t] = this),
                  (n[t] = arguments.length > 1 ? ce.call(arguments) : i),
                  --e || o.resolveWith(s, n);
              };
            };
          if (
            1 >= e &&
            (u(t, o.done(r(i)).resolve, o.reject, !e),
            "pending" === o.state() || _e(n[i] && n[i].then))
          )
            return o.then();
          for (; i--; ) u(n[i], r(i), o.reject);
          return o.promise();
        },
      });
    var ze = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
    (Ce.Deferred.exceptionHook = function (e, i) {
      t.console &&
        t.console.warn &&
        e &&
        ze.test(e.name) &&
    ...
    var Le = Ce.Deferred();
    (Ce.fn.ready = function (t) {
      return (
        Le.then(t).catch(function (t) {
          Ce.readyException(t);
        }),
        this
      );
      ...
      Ce.extend({
        ...
        readyWait: 1,
        ready: function (t) {
          (t === !0 ? --Ce.readyWait : Ce.isReady) ||
            ((Ce.isReady = !0),
            (t !== !0 && --Ce.readyWait > 0) || Le.resolveWith(le, [Ce]));
        },
      }),
      (Ce.ready.then = Le.then),
      "complete" === le.readyState ||
      ("loading" !== le.readyState && !le.documentElement.doScroll)
        ? t.setTimeout(Ce.ready)
        : (le.addEventListener("DOMContentLoaded", d),
          t.addEventListener("load", d));
    var We = function (t, e, i, n, o, r, a) {
        var l = 0,
          h = t.length,
          c = null == i;
        if ("object" === s(i)) {
          o = !0;
          for (l in i) We(t, e, l, i[l], !0, r, a);
        } else if (
          void 0 !== n &&
          ((o = !0),
          _e(n) || (a = !0),
          ...
          for (; h > l; l++) e(t[l], i, a ? n : n.call(t[l], l, e(t[l], i)));
    ...
    (g.uid = 1),
      (g.prototype = {
        ...
        set: function (t, e, i) {
          var s,
            n = this.cache(t);
          if ("string" == typeof e) n[f(e)] = i;
          else for (s in e) n[f(s)] = e[s];
          return n;
        },
        get: function (t, e) {
          return void 0 === e
        ...
        remove: function (t, e) {
          ...
          if (void 0 !== s) {
            if (void 0 !== e) {
              Array.isArray(e)
                ? (e = e.map(f))
                : ((e = f(e)), (e = e in s ? [e] : e.match(He) || [])),
                (i = e.length);
              for (; i--; ) delete s[e[i]];
            }
            (void 0 === e || Ce.isEmptyObject(s)) &&
              (t.nodeType
    ...
    Ce.extend({
      hasData: function (t) {
        return Be.hasData(t) || qe.hasData(t);
      },
      data: function (t, e, i) {
      ...
      Ce.fn.extend({
        data: function (t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((n = Be.get(o)), 1 === o.nodeType && !qe.get(o, "hasDataAttrs"))
            ) {
              for (i = r.length; i--; )
                r[i] &&
                  ((s = r[i].name),
                  0 === s.indexOf("data-") &&
                    ((s = f(s.slice(5))), v(o, s, n[s])));
        ...
        queue: function (t, e, i) {
          ...
          return t
            ? ((e = (e || "fx") + "queue"),
              ...
              i &&
                (!s || Array.isArray(i)
                  ? (s = qe.access(t, e, Ce.makeArray(i)))
                  : s.push(i)),
              s || [])
            : void 0;
        },
      ...
      Ce.fn.extend({
        queue: function (t, e) {
          ...
          return (
            ...
            arguments.length < i
              ...
              ? this
              : this.each(function () {
                  var i = Ce.queue(this, t, e);
                  Ce._queueHooks(this, t),
                    "fx" === t && "inprogress" !== i[0] && Ce.dequeue(this, t);
                })
          );
        },
        dequeue: function (t) {
        ...
        promise: function (t, e) {
          ...
          for (
            ...
            (i = qe.get(o[r], t + "queueHooks")),
              i && i.empty && (s++, i.empty.add(a));
    ...
    var Ve = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
      ...
      Qe = function (t) {
        return Ce.contains(t.ownerDocument, t);
      },
      Je = { composed: !0 };
    Ge.getRootNode &&
      (Qe = function (t) {
        return (
          Ce.contains(t.ownerDocument, t) ||
          t.getRootNode(Je) === t.ownerDocument
        );
      });
    var Ze = function (t, e) {
        return (
          ...
          "none" === t.style.display ||
            ("" === t.style.display && Qe(t) && "none" === Ce.css(t, "display"))
        );
      },
      ti = function (t, e, i, s) {
        var n,
    ...
    var ri = /<|&#?\w+;/;
    !(function () {
      var t = le.createDocumentFragment(),
        e = t.appendChild(le.createElement("div")),
        i = le.createElement("input");
    ...
    (Ce.event = {
        ...
        if (m)
          for (
            i.handler && ((o = i), (i = o.handler), (n = o.selector)),
              n && Ce.find.matchesSelector(Ge, n),
            ...
            (a = hi.exec(e[h]) || []),
              ...
              p &&
                ...
                (c = Ce.extend(
                  {
                    ...
                    guid: i.guid,
                    selector: n,
                    needsContext: n && Ce.expr.match.needsContext.test(n),
                    namespace: f.join("."),
                  },
                  o
                )),
                (d = l[p]) ||
                  ((d = l[p] = []),
                  (d.delegateCount = 0),
                  (u.setup && u.setup.call(t, s, f, r) !== !1) ||
      ...
      remove: function (t, e, i, s, n) {
        var o,
          ...
          f,
          g,
          m = qe.hasData(t) && qe.get(t);
        if (m && (l = m.events)) {
          for (e = (e || "").match(He) || [""], h = e.length; h--; )
            if (
              ((a = hi.exec(e[h]) || []),
              (p = g = a[1]),
              (f = (a[2] || "").split(".").sort()),
              ...
              r &&
                ...
                ((u.teardown && u.teardown.call(t, f, m.handle) !== !1) ||
                  Ce.removeEvent(t, p, m.handle),
                delete l[p]);
            } else for (p in l) Ce.event.remove(t, p + e[h], i, s, !0);
          Ce.isEmptyObject(l) && qe.remove(t, "handle events");
        }
      },
      dispatch: function (t) {
        var e,
        ...
        if (
          ...
          for (
            r = Ce.event.handlers.call(this, a, h), e = 0;
      ...
      fix: function (t) {
        return t[Ce.expando] ? t : new Ce.Event(t);
      },
      special: {
        load: { noBubble: !0 },
        click: {
          setup: function (t) {
            var e = this || t;
            return (
              ii.test(e.type) && e.click && o(e, "input") && P(e, "click", C),
              !1
            );
          },
          trigger: function (t) {
            var e = this || t;
            return (
              ii.test(e.type) && e.click && o(e, "input") && P(e, "click"), !0
            );
          },
          _default: function (t) {
            var e = t.target;
      ...
      Ce.each(
        {
          ...
          which: function (t) {
            var e = t.button;
            return null == t.which && ai.test(t.type)
              ? null != t.charCode
                ? t.charCode
                : t.keyCode
              : !t.which && void 0 !== e && li.test(t.type)
              ? 1 & e
                ? 1
                : 2 & e
                ? 3
      ...
      Ce.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
        Ce.event.special[t] = {
          setup: function () {
            return P(this, t, S), !1;
          },
      ...
      Ce.fn.extend({
        ...
        off: function (t, e, i) {
          ...
          return (
            ...
            i === !1 && (i = T),
            this.each(function () {
              Ce.event.remove(this, t, i, e);
            })
          );
        },
      });
    var ci = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
      ui = /<script|<style|<link/i,
      di = /checked\s*(?:[^=]|=\s*.checked.)/i,
      pi = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    Ce.extend({
      htmlPrefilter: function (t) {
        return t.replace(ci, "<$1></$2>");
      },
      clone: function (t, e, i) {
        ...
        if (
          ...
          for (r = w(a), o = w(t), s = 0, n = o.length; n > s; s++)
            M(o[s], r[s]);
        if (e)
          if (i)
            for (o = o || w(t), r = r || w(a), s = 0, n = o.length; n > s; s++)
              O(o[s], r[s]);
          else O(t, a);
        return (
          (r = w(a, "script")), r.length > 0 && x(r, !l && w(t, "script")), a
        );
      },
      cleanData: function (t) {
        for (
          var e, i, s, n = Ce.event.special, o = 0;
          void 0 !== (i = t[o]);
          o++
        )
          if (Re(i)) {
            if ((e = i[qe.expando])) {
              if (e.events)
                for (s in e.events)
                  n[s] ? Ce.event.remove(i, s) : Ce.removeEvent(i, s, e.handle);
              i[qe.expando] = void 0;
            }
            i[Be.expando] && (i[Be.expando] = void 0);
          }
      },
    }),
      Ce.fn.extend({
        ...
        empty: function () {
          for (var t, e = 0; null != (t = this[e]); e++)
            1 === t.nodeType && (Ce.cleanData(w(t, !1)), (t.textContent = ""));
          return this;
        },
        clone: function (t, e) {
          return (
          ...
          return We(
            ...
            function (t) {
              ...
              if (
                "string" == typeof t &&
                !ui.test(t) &&
                !oi[(si.exec(t) || ["", ""])[1].toLowerCase()]
              ) {
                t = Ce.htmlPrefilter(t);
                try {
                  for (; s > i; i++)
                    (e = this[i] || {}),
                      1 === e.nodeType &&
                        (Ce.cleanData(w(e, !1)), (e.innerHTML = t));
                  e = 0;
                } catch (n) {}
              }
        ...
        replaceWith: function () {
          ...
          return N(
            ...
            function (e) {
              ...
              Ce.inArray(this, t) < 0 &&
                (Ce.cleanData(w(this)), i && i.replaceChild(e, this));
            },
            t
          );
        },
      ...
      Ce.each(
        ...
        function (t, e) {
          Ce.fn[t] = function (t) {
            for (var i, s = [], n = Ce(t), o = n.length - 1, r = 0; o >= r; r++)
    ...
    var fi = new RegExp("^(" + Ve + ")(?!px)[a-z%]+$", "i"),
      gi = function (e) {
        var i = e.ownerDocument.defaultView;
        return (i && i.opener) || (i = t), i.getComputedStyle(e);
      },
      mi = new RegExp(Xe.join("|"), "i");
    !(function () {
      function e() {
        if (h) {
          (l.style.cssText =
            ...
            Ge.appendChild(l).appendChild(h);
      ...
      h.style &&
        ...
        (ye.clearCloneStyle = "content-box" === h.style.backgroundClip),
        Ce.extend(ye, {
    ...
    var vi = ["Webkit", "Moz", "ms"],
      bi = le.createElement("div").style,
      yi = {},
      _i = /^(none|table(?!-c[ea]).+)/,
      wi = /^--/,
      xi = { position: "absolute", visibility: "hidden", display: "block" },
    ...
    Ce.extend({
      ...
      style: function (t, e, i, s) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          ...
          return (
            l || (e = j(a)),
            (r = Ce.cssHooks[e] || Ce.cssHooks[a]),
            void 0 === i
              ? r && "get" in r && void 0 !== (n = r.get(t, !1, s))
                ? n
                : h[e]
              : ((o = typeof i),
                "string" === o &&
                ...
                null != i &&
                  ...
                  ("number" !== o ||
                    l ||
                    (i += (n && n[3]) || (Ce.cssNumber[a] ? "" : "px")),
                  ye.clearCloneStyle ||
                    "" !== i ||
                    0 !== e.indexOf("background") ||
                    (h[e] = "inherit"),
                  (r && "set" in r && void 0 === (i = r.set(t, i, s))) ||
      ...
      css: function (t, e, i, s) {
        ...
        return (
          l || (e = j(a)),
          (r = Ce.cssHooks[e] || Ce.cssHooks[a]),
          r && "get" in r && (n = r.get(t, !0, i)),
          void 0 === n && (n = z(t, e, s)),
          "normal" === n && e in ki && (n = ki[e]),
          "" === i || i
            ? ((o = parseFloat(n)), i === !0 || isFinite(o) ? o || 0 : n)
            : n
        );
      },
    }),
      Ce.each(["height", "width"], function (t, e) {
        Ce.cssHooks[e] = {
          ...
          set: function (t, i, s) {
            var n,
              o = gi(t),
              r = !ye.scrollboxSize() && "absolute" === o.position,
              a = r || s,
              l = a && "border-box" === Ce.css(t, "boxSizing", !1, o),
              h = s ? R(t, e, s, l, o) : 0;
            return (
              l &&
                r &&
              ...
              h &&
                (n = Ke.exec(i)) &&
                "px" !== (n[3] || "px") &&
                ((t.style[e] = i), (i = Ce.css(t, e))),
              F(t, i, h)
            );
          },
        };
      }),
      (Ce.cssHooks.marginLeft = L(ye.reliableMarginLeft, function (t, e) {
        return e
          ? (parseFloat(z(t, "marginLeft")) ||
      ...
      Ce.each({ margin: "", padding: "", border: "Width" }, function (t, e) {
        (Ce.cssHooks[t + e] = {
          expand: function (i) {
            for (
              var s = 0, n = {}, o = "string" == typeof i ? i.split(" ") : [i];
              4 > s;
              s++
            )
              n[t + Xe[s] + e] = o[s] || o[s - 2] || o[0];
            return n;
          },
        }),
          "margin" !== t && (Ce.cssHooks[t + e].set = F);
      }),
      Ce.fn.extend({
        css: function (t, e) {
          return We(
            ...
            function (t, e, i) {
              var s,
                ...
                r = 0;
              if (Array.isArray(e)) {
                for (s = gi(t), n = e.length; n > r; r++)
                  o[e[r]] = Ce.css(t, e[r], !1, s);
                return o;
              }
              return void 0 !== i ? Ce.style(t, e, i) : Ce.css(t, e);
            },
            t,
            e,
            arguments.length > 1
      ...
      (B.prototype = {
        ...
        init: function (t, e, i, s, n, o) {
          (this.elem = t),
            (this.prop = i),
            (this.easing = n || Ce.easing._default),
            (this.options = e),
            (this.start = this.now = this.cur()),
            (this.end = s),
            (this.unit = o || (Ce.cssNumber[i] ? "" : "px"));
        },
        cur: function () {
        ...
        _default: {
          get: function (t) {
            ...
            return 1 !== t.elem.nodeType ||
              ...
              ? t.elem[t.prop]
              : ((e = Ce.css(t.elem, t.prop, "")), e && "auto" !== e ? e : 0);
          },
          set: function (t) {
            Ce.fx.step[t.prop]
              ? Ce.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType ||
                (!Ce.cssHooks[t.prop] && null == t.elem.style[j(t.prop)])
              ? (t.elem[t.prop] = t.now)
              : Ce.style(t.elem, t.prop, t.now + t.unit);
          },
        },
      }),
    ...
    (Ce.Animation = Ce.extend(Q, {
      tweeners: {
        "*": [
          function (t, e) {
            ...
            return b(i.elem, t, Ke.exec(e), i), i;
          },
        ],
      },
      tweener: function (t, e) {
        _e(t) ? ((e = t), (t = ["*"])) : (t = t.match(He));
        ...
        return (
          Ce.fx.off
            ...
            : "number" != typeof s.duration &&
              (s.duration =
                s.duration in Ce.fx.speeds
                  ? Ce.fx.speeds[s.duration]
                  : Ce.fx.speeds._default),
          (null == s.queue || s.queue === !0) && (s.queue = "fx"),
          (s.old = s.complete),
          (s.complete = function () {
            _e(s.old) && s.old.call(this), s.queue && Ce.dequeue(this, s.queue);
          }),
          s
        );
      }),
      Ce.fn.extend({
        ...
        animate: function (t, e, i, s) {
          var n = Ce.isEmptyObject(t),
            o = Ce.speed(e, i, s),
            r = function () {
              var e = Q(this, Ce.extend({}, t), o);
              (n || qe.get(this, "finish")) && e.stop(!0);
            };
          return (
            (r.finish = r),
            n || o.queue === !1 ? this.each(r) : this.queue(o.queue, r)
          );
        },
        stop: function (t, e, i) {
          var s = function (t) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (n in r) r[n] && r[n].stop && Di.test(n) && s(r[n]);
              for (n = o.length; n--; )
                o[n].elem !== this ||
                  (null != t && o[n].queue !== t) ||
      ...
      Ce.each(["toggle", "show", "hide"], function (t, e) {
        var i = Ce.fn[e];
        Ce.fn[e] = function (t, s, n) {
          return null == t || "boolean" == typeof t
            ? i.apply(this, arguments)
            : this.animate(V(e, !0), t, s, n);
        };
      }),
      Ce.each(
        {
      ...
      (Ce.fx.tick = function () {
        var t,
          e = 0,
          i = Ce.timers;
        for (Ci = Date.now(); e < i.length; e++)
          (t = i[e]), t() || i[e] !== t || i.splice(e--, 1);
        i.length || Ce.fx.stop(), (Ci = void 0);
      }),
      (Ce.fx.timer = function (t) {
        Ce.timers.push(t), Ce.fx.start();
      }),
      (Ce.fx.interval = 13),
      ...
      (function () {
        var t = le.createElement("input"),
          e = le.createElement("select"),
          i = e.appendChild(le.createElement("option"));
        (t.type = "checkbox"),
          (ye.checkOn = "" !== t.value),
          (ye.optSelected = i.selected),
    ...
    var $i,
      Pi = Ce.expr.attrHandle;
    Ce.fn.extend({
      attr: function (t, e) {
        return We(this, Ce.attr, t, e, arguments.length > 1);
      },
        ...
        attr: function (t, e, i) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return "undefined" == typeof t.getAttribute
              ...
              : ((1 === o && Ce.isXMLDoc(t)) ||
                  (n =
                    Ce.attrHooks[e.toLowerCase()] ||
                    (Ce.expr.match.bool.test(e) ? $i : void 0)),
                void 0 !== i
                  ? null === i
                    ? (Ce.removeAttr(t, e), void 0)
                    : n && "set" in n && void 0 !== (s = n.set(t, i, e))
                    ? s
                    : (t.setAttribute(e, i + ""), i)
                  : n && "get" in n && null !== (s = n.get(t, e))
                  ? s
                  : ((s = Ce.find.attr(t, e)), null == s ? void 0 : s));
        },
        attrHooks: {
          type: {
            set: function (t, e) {
              if (!ye.radioValue && "radio" === e && o(t, "input")) {
                var i = t.value;
      ...
      ($i = {
        set: function (t, e, i) {
          return e === !1 ? Ce.removeAttr(t, i) : t.setAttribute(i, i), i;
        },
      }),
      Ce.each(Ce.expr.match.bool.source.match(/\w+/g), function (t, e) {
        var i = Pi[e] || Ce.find.attr;
        Pi[e] = function (t, e, s) {
          var n,
            o,
            r = e.toLowerCase();
    ...
    var Ii = /^(?:input|select|textarea|button)$/i,
      Ai = /^(?:a|area)$/i;
    Ce.fn.extend({
      prop: function (t, e) {
        return We(this, Ce.prop, t, e, arguments.length > 1);
      },
      removeProp: function (t) {
        return this.each(function () {
          delete this[Ce.propFix[t] || t];
        });
      },
    }),
      Ce.extend({
        prop: function (t, e, i) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return (
              (1 === o && Ce.isXMLDoc(t)) ||
                ((e = Ce.propFix[e] || e), (n = Ce.propHooks[e])),
              void 0 !== i
                ? n && "set" in n && void 0 !== (s = n.set(t, i, e))
                  ? s
                  : (t[e] = i)
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : Ii.test(t.nodeName) || (Ai.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
      ...
      Ce.fn.extend({
        addClass: function (t) {
          ...
          if (_e(t))
            return this.each(function (e) {
              Ce(this).addClass(t.call(this, e, Z(this)));
            });
          if (((e = te(t)), e.length))
            for (; (i = this[l++]); )
              if (((n = Z(i)), (s = 1 === i.nodeType && " " + J(n) + " "))) {
                for (r = 0; (o = e[r++]); )
                  s.indexOf(" " + o + " ") < 0 && (s += o + " ");
                (a = J(s)), n !== a && i.setAttribute("class", a);
              }
          return this;
        },
        removeClass: function (t) {
          ...
          if (_e(t))
            return this.each(function (e) {
              Ce(this).removeClass(t.call(this, e, Z(this)));
            });
        ...
        toggleClass: function (t, e) {
          ...
          return "boolean" == typeof e && s
            ...
            ? this.each(function (i) {
                Ce(this).toggleClass(t.call(this, i, Z(this), e), e);
              })
            : this.each(function () {
                var e, n, o, r;
                if (s)
                  for (n = 0, o = Ce(this), r = te(t); (e = r[n++]); )
                    o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                  (void 0 === t || "boolean" === i) &&
                    ((e = Z(this)),
                    e && qe.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        e || t === !1 ? "" : qe.get(this, "__className__") || ""
                      ));
              });
        },
        hasClass: function (t) {
          var e,
            ...
            s = 0;
          for (e = " " + t + " "; (i = this[s++]); )
            if (1 === i.nodeType && (" " + J(Z(i)) + " ").indexOf(e) > -1)
              return !0;
          return !1;
        },
      });
      ...
      val: function (t) {
          ...
          n = this[0];
        {
          if (arguments.length)
            return (
              ...
              this.each(function (i) {
                var n;
                1 === this.nodeType &&
                  ((n = s ? t.call(this, i, Ce(this).val()) : t),
                  null == n
                    ? (n = "")
                    : "number" == typeof n
                    ? (n += "")
                    : Array.isArray(n) &&
                      (n = Ce.map(n, function (t) {
                        return null == t ? "" : t + "";
                      })),
                  (e =
          ...
          if (n)
            return (
              (e =
                Ce.valHooks[n.type] || Ce.valHooks[n.nodeName.toLowerCase()]),
              e && "get" in e && void 0 !== (i = e.get(n, "value"))
                ? i
                : ((i = n.value),
                  "string" == typeof i ? i.replace(Ei, "") : null == i ? "" : i)
            );
        }
      },
    }),
      Ce.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var i, s, n = t.options, o = Ce.makeArray(e), r = n.length;
                r--;

              )
                (s = n[r]),
                  (s.selected =
                    Ce.inArray(Ce.valHooks.option.get(s), o) > -1) && (i = !0);
        ...
        (Ce.valHooks[this] = {
          set: function (t, e) {
            return Array.isArray(e)
              ? (t.checked = Ce.inArray(Ce(t).val(), e) > -1)
              : void 0;
          },
        }),
          ye.checkOn ||
            (Ce.valHooks[this].get = function (t) {
              return null === t.getAttribute("value") ? "on" : t.value;
            });
      }),
      (ye.focusin = "onfocusin" in t);
    var Oi = /^(?:focusinfocus|focusoutblur)$/,
      Mi = function (t) {
        t.stopPropagation();
      };
    Ce.extend(Ce.event, {
      trigger: function (e, i, s, n) {
        var o,
          ...
          d,
          p = [s || le],
          f = me.call(e, "type") ? e.type : e,
          g = me.call(e, "namespace") ? e.namespace.split(".") : [];
        if (
          ((r = d = a = s = s || le),
          3 !== s.nodeType &&
            8 !== s.nodeType &&
            !Oi.test(f + Ce.event.triggered) &&
            (f.indexOf(".") > -1 &&
            ...
            (e.result = void 0),
            e.target || (e.target = s),
            (i = null == i ? [e] : Ce.makeArray(i, [e])),
            (u = Ce.event.special[f] || {}),
            n || !u.trigger || u.trigger.apply(s, i) !== !1))
        ) {
          if (!n && !u.noBubble && !we(s)) {
            for (
              l = u.delegateType || f, Oi.test(l + f) || (r = r.parentNode);
              r;
              r = r.parentNode
            )
              p.push(r), (a = r);
            a === (s.ownerDocument || le) &&
              p.push(a.defaultView || a.parentWindow || t);
          }
          for (o = 0; (r = p[o++]) && !e.isPropagationStopped(); )
            (d = r),
              (e.type = o > 1 ? l : u.bindType || f),
              (c = (qe.get(r, "events") || {})[e.type] && qe.get(r, "handle")),
              c && c.apply(r, i),
              (c = h && r[h]),
              c &&
                c.apply &&
          ...
          return (
            ...
            n ||
              ...
              (h &&
                ...
                e.isPropagationStopped() && d.addEventListener(f, Mi),
                s[f](),
                e.isPropagationStopped() && d.removeEventListener(f, Mi),
      ...
      simulate: function (t, e, i) {
        var s = Ce.extend(new Ce.Event(), i, { type: t, isSimulated: !0 });
        Ce.event.trigger(s, null, e);
      },
    }),
      Ce.fn.extend({
        ...
        triggerHandler: function (t, e) {
          var i = this[0];
          return i ? Ce.event.trigger(t, e, i, !0) : void 0;
        },
      }),
      ye.focusin ||
        Ce.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
          var i = function (t) {
            Ce.event.simulate(e, t.target, Ce.event.fix(t));
          };
          Ce.event.special[e] = {
            setup: function () {
              var s = this.ownerDocument || this,
                n = qe.access(s, e);
              n || s.addEventListener(t, i, !0), qe.access(s, e, (n || 0) + 1);
            },
            teardown: function () {
              var s = this.ownerDocument || this,
                n = qe.access(s, e) - 1;
              n
                ? qe.access(s, e, n)
                : (s.removeEventListener(t, i, !0), qe.remove(s, e));
            },
          };
        });
    var Ni = t.location,
    ...
    var Li = /\[\]$/,
      Wi = /\r?\n/g,
      ji = /^(?:submit|button|image|reset|file)$/i,
      Fi = /^(?:input|select|textarea|keygen)/i;
    (Ce.param = function (t, e) {
      var i,
        s = [],
        n = function (t, e) {
          var i = _e(e) ? e() : e;
      ...
      if (null == t) return "";
      if (Array.isArray(t) || (t.jquery && !Ce.isPlainObject(t)))
        Ce.each(t, function () {
          n(this.name, this.value);
        });
      else for (i in t) ee(i, t[i], e, n);
      return s.join("&");
    }),
      Ce.fn.extend({
        serialize: function () {
          ...
          return this.map(function () {
            ...
            .map(function (t, e) {
              ...
              return null == i
                ...
                : Array.isArray(i)
                ? Ce.map(i, function (t) {
                    return { name: e.name, value: t.replace(Wi, "\r\n") };
                  })
    ...
    var Ri = /%20/g,
      ...
      Bi = /([?&])_=[^&]*/,
      Ui = /^(.*?):[ \t]*([^\r\n]*)$/gm,
      Yi = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/,
      Vi = /^(?:GET|HEAD)$/,
      Ki = /^\/\//,
      Xi = {},
      Gi = {},
      Qi = "*/".concat("*"),
      Ji = le.createElement("a");
    (Ji.href = Ni.href),
      Ce.extend({
        active: 0,
        lastModified: {},
        ...
        ajaxSetup: function (t, e) {
          return e ? ne(ne(t, Ce.ajaxSettings), e) : ne(Ce.ajaxSettings, t);
        },
        ajaxPrefilter: ie(Xi),
        ajaxTransport: ie(Gi),
        ajax: function (e, i) {
          function s(e, i, s, a) {
            ...
            c ||
              ...
              h
                ? (f.ifModified &&
                  ...
                  204 === e || "HEAD" === f.type
                    ...
                    : 304 === e
                    ? (x = "notmodified")
                    : ((x = _.state), (d = _.data), (p = _.error), (h = !p)))
                : ((p = x), (e || !x) && ((x = "error"), 0 > e && (e = 0))),
              (k.status = e),
              (k.statusText = (i || x) + ""),
              ...
              (y = void 0),
              u &&
                m.trigger(h ? "ajaxSuccess" : "ajaxError", [k, f, h ? d : p]),
              b.fireWith(g, [k, x]),
              u &&
          ...
          var n,
            ...
            f = Ce.ajaxSetup({}, i),
            g = f.context || f,
            m = f.context && (g.nodeType || g.jquery) ? Ce(g) : Ce.event,
            v = Ce.Deferred(),
          ...
          if (
            (v.promise(k),
            (f.url = ((e || f.url || Ni.href) + "").replace(
              Ki,
              Ni.protocol + "//"
            )),
            (f.type = i.method || i.type || f.method || f.type),
            (f.dataTypes = (f.dataType || "*").toLowerCase().match(He) || [""]),
            null == f.crossDomain)
          ) {
            h = le.createElement("a");
            try {
              (h.href = f.url),
                (h.href = h.href),
                (f.crossDomain =
                  Ji.protocol + "//" + Ji.host != h.protocol + "//" + h.host);
            } catch (C) {
              f.crossDomain = !0;
            }
          }
          ...
          (u = Ce.event && f.global),
            ...
            f.hasContent
              ? f.data &&
                ...
                (f.data = f.data.replace(Ri, "+"))
              : ((p = f.url.slice(o.length)),
                f.data &&
                  (f.processData || "string" == typeof f.data) &&
                  ((o += (zi.test(o) ? "&" : "?") + f.data), delete f.data),
                f.cache === !1 &&
                  ((o = o.replace(Bi, "$1")),
                  (p = (zi.test(o) ? "&" : "?") + "_=" + Hi++ + p)),
                (f.url = o + p)),
            f.ifModified &&
              (Ce.lastModified[o] &&
                k.setRequestHeader("If-Modified-Since", Ce.lastModified[o]),
              Ce.etag[o] && k.setRequestHeader("If-None-Match", Ce.etag[o])),
            ...
            k.setRequestHeader(
              ...
              f.dataTypes[0] && f.accepts[f.dataTypes[0]]
                ? f.accepts[f.dataTypes[0]] +
                    ("*" !== f.dataTypes[0] ? ", " + Qi + "; q=0.01" : "")
                : f.accepts["*"]
            );
          for (d in f.headers) k.setRequestHeader(d, f.headers[d]);
          if (f.beforeSend && (f.beforeSend.call(g, k, f) === !1 || c))
            return k.abort();
          if (
            ((x = "abort"),
            b.add(f.complete),
        ...
        getScript: function (t, e) {
          return Ce.get(t, void 0, e, "script");
        },
      }),
      Ce.each(["get", "post"], function (t, e) {
        Ce[e] = function (t, i, s, n) {
          return (
            _e(i) && ((n = n || s), (s = i), (i = void 0)),
            Ce.ajax(
              Ce.extend(
                { url: t, type: e, dataType: n, data: i, success: s },
                Ce.isPlainObject(t) && t
              )
            )
          );
        };
      }),
      (Ce._evalUrl = function (t, e) {
        return Ce.ajax({
          url: t,
          type: "GET",
          dataType: "script",
      ...
      Ce.fn.extend({
        wrapAll: function (t) {
          ...
          return (
            this[0] &&
              (_e(t) && (t = t.call(this[0])),
              (e = Ce(t, this[0].ownerDocument).eq(0).clone(!0)),
      ...
      (Ce.expr.pseudos.hidden = function (t) {
        return !Ce.expr.pseudos.visible(t);
      }),
      (Ce.expr.pseudos.visible = function (t) {
    ...
    var Zi = { 0: 200, 1223: 204 },
      ts = Ce.ajaxSettings.xhr();
    (ye.cors = !!ts && "withCredentials" in ts),
      (ye.ajax = ts = !!ts),
      Ce.ajaxTransport(function (e) {
        var i, s;
        return ye.cors || (ts && !e.crossDomain)
          ? {
              send: function (n, o) {
                var r,
                  a = e.xhr();
                ...
                (i = function (t) {
                  return function () {
                    i &&
                      ((i = s = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null),
                      "abort" === t
                        ? a.abort()
                        : "error" === t
                  ...
                  (a.onload = i()),
                  (s = a.onerror = a.ontimeout = i("error")),
                  void 0 !== a.onabort
                    ? (a.onabort = s)
    ...
    Ce.ajaxSetup({
      ...
      jsonpCallback: function () {
        var t = es.pop() || Ce.expando + "_" + Hi++;
        return (this[t] = !0), t;
      },
    }),
      Ce.ajaxPrefilter("json jsonp", function (e, i, s) {
        var n,
          o,
          r,
          a =
        ...
        return a || "jsonp" === e.dataTypes[0]
          ? ((n = e.jsonpCallback = _e(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
            a
              ? (e[a] = e[a].replace(is, "$1" + n))
              : e.jsonp !== !1 &&
                (e.url += (zi.test(e.url) ? "&" : "?") + e.jsonp + "=" + n),
            (e.converters["script json"] = function () {
              return r || Ce.error(n + " was not called"), r[0];
            }),
            (e.dataTypes[0] = "json"),
            (o = t[n]),
            (t[n] = function () {
            ...
            s.always(function () {
              void 0 === o ? Ce(t).removeProp(n) : (t[n] = o),
                e[n] && ((e.jsonpCallback = i.jsonpCallback), es.push(n)),
                r && _e(o) && o(r[0]),
                (r = o = void 0);
            }),
            "script")
      ...
      (ye.createHTMLDocument = (function () {
        var t = le.implementation.createHTMLDocument("").body;
        return (
          (t.innerHTML = "<form></form><form></form>"),
          2 === t.childNodes.length
        );
      })()),
      (Ce.parseHTML = function (t, e, i) {
        ...
        return (
          e ||
            (ye.createHTMLDocument
              ? ((e = le.implementation.createHTMLDocument("")),
                (s = e.createElement("base")),
                (s.href = le.location.href),
      ...
      (Ce.fn.load = function (t, e, i) {
        var s,
          ...
          a = t.indexOf(" ");
        return (
          a > -1 && ((s = J(t.slice(a))), (t = t.slice(0, a))),
          _e(e)
            ? ((i = e), (e = void 0))
            : e && "object" == typeof e && (n = "POST"),
          r.length > 0 &&
            Ce.ajax({ url: t, type: n || "GET", dataType: "html", data: e })
              .done(function (t) {
                (o = arguments),
                  r.html(s ? Ce("<div>").append(Ce.parseHTML(t)).find(s) : t);
              })
              .always(
                i &&
                  function (t, e) {
        ...
        setOffset: function (t, e, i) {
          ...
          "static" === c && (t.style.position = "relative"),
            ...
            (h =
              ...
              (o + l).indexOf("auto") > -1),
            h
              ? ((s = u.position()), (r = s.top), (n = s.left))
              : ((r = parseFloat(o) || 0), (n = parseFloat(l) || 0)),
            _e(e) && (e = e.call(t, i, Ce.extend({}, a))),
          ...
          if (this[0]) {
            ...
            if ("fixed" === Ce.css(s, "position"))
              ...
              t &&
                ...
                1 === t.nodeType &&
                ((n = Ce(t).offset()),
                (n.top += Ce.css(t, "borderTopWidth", !0)),
                (n.left += Ce.css(t, "borderLeftWidth", !0)));
            }
            return {
              top: e.top - n.top - Ce.css(s, "marginTop", !0),
              left: e.left - n.left - Ce.css(s, "marginLeft", !0),
            };
          }
        },
          ...
          Ce.fn[t] = function (s) {
            return We(
              ...
              function (t, s, n) {
                var o;
                return (
                  we(t) ? (o = t) : 9 === t.nodeType && (o = t.defaultView),
                  void 0 === n
                    ? o
                      ? o[e]
                      : t[s]
      ...
      Ce.each(["top", "left"], function (t, e) {
        Ce.cssHooks[e] = L(ye.pixelPosition, function (t, i) {
          return i
            ? ((i = z(t, e)), fi.test(i) ? Ce(t).position()[e] + "px" : i)
            : void 0;
        });
      }),
      ...
      (Ce.proxy = function (t, e) {
        var i, s, n;
        return (
          "string" == typeof e && ((i = t[e]), (e = t), (t = i)),
          _e(t)
            ? ((s = ce.call(arguments, 2)),
              (n = function () {
                return t.apply(e || this, s.concat(ce.call(arguments)));
              }),
              (n.guid = t.guid = t.guid || Ce.guid++),
              n)
            : void 0
        );
      }),
      (Ce.holdReady = function (t) {
    ...
    return (
      (Ce.noConflict = function (e) {
        return (
          t.$ === Ce && (t.$ = ns), e && t.jQuery === Ce && (t.jQuery = ss), Ce
        );
      }),
      e || (t.jQuery = t.$ = Ce),
      Ce
  ...
  (function (t, e) {
    ...
    function i(i, s, o, a, l) {
      function h() {
        (C = t.devicePixelRatio > 1),
          ...
          (s.delay < 0 || s.combined) &&
            ((a.e = b(s.throttle, function (t) {
              "resize" === t.type && (x = k = -1), u(t.all);
            })),
            (a.a = function (t) {
            ...
            u(),
            n(s.appendScroll).on("scroll." + l + " resize." + l, a.e));
      }
      function c(t) {
        ...
        t = n(t)
          .filter(function () {
            var t = n(this),
              i = m(this);
            return (
              !t.data(s.handledName) &&
              (t.attr(s.attribute) || t.attr(l) || t.attr(h) || c[i] !== e)
            );
          })
          .data("plugin_" + s.name, i);
        for (var u = 0, d = t.length; d > u; u++) {
          var p = n(t[u]),
            f = m(t[u]),
            g = p.attr(s.imageBaseAttribute) || a;
          f === $ && g && p.attr(l) && p.attr(l, v(p.attr(l), g)),
            c[f] === e || p.attr(h) || p.attr(h, c[f]),
            f === $ && o && !p.attr(P)
              ? p.attr(P, o)
              : f === $ ||
                !r ||
                (p.css(E) && "none" !== p.css(E)) ||
                p.css(E, "url('" + r + "')");
        }
        return t;
      }
      function u(t, e) {
        if (!o.length) return s.autoDestroy && i.destroy(), void 0;
        for (
          var r = e || o,
            a = !1,
            l = s.imageBase || "",
          ...
          if (t || e || p(r[u])) {
            var f = n(r[u]),
              g = m(r[u]),
              v = f.attr(s.attribute),
              b = f.attr(s.imageBaseAttribute) || l,
              y = f.attr(s.loaderAttribute);
            f.data(c) ||
              (s.visibleOnly && !f.is(":visible")) ||
              !(
                ((v || f.attr(h)) &&
                  ((g === $ &&
                    (b + v !== f.attr(P) || f.attr(h) !== f.attr(I))) ||
                    (g !== $ && b + v !== f.css(E)))) ||
                y
              ) ||
              ((a = !0), f.data(c, !0), d(f, g, b, y));
          }
        a &&
          (o = n(o).filter(function () {
      ...
      function d(t, e, i, o) {
        ...
        if (o) {
          var f = function () {
            u && t.removeAttr(s.loaderAttribute),
              t.data(d, !0),
              _(T, t),
              setTimeout(y, 1),
              (f = n.noop);
          };
          t.off(D).one(D, r).one(S, f),
            _(o, t, function (e) {
              e ? (t.off(S), f()) : (t.off(D), r());
            }) || t.trigger(D);
        } else {
          var g = n(new Image());
          g.one(D, r).one(S, function () {
            t.hide(),
              e === $
                ? t.attr(A, g.attr(A)).attr(I, g.attr(I)).attr(P, g.attr(P))
                : t.css(E, "url('" + g.attr(P) + "')"),
              t[s.effect](s.effectTime),
              u &&
                (t.removeAttr(
                  a + " " + l + " " + c + " " + s.imageBaseAttribute
                ),
                h !== A && t.removeAttr(h)),
              t.data(d, !0),
              _(T, t),
      ...
      function f() {
        return x >= 0 ? x : (x = n(t).width());
      }
      function g() {
        return k >= 0 ? k : (k = n(t).height());
      }
      function m(t) {
      ...
      function b(t, e) {
        ...
        return function (r, a) {
          ...
          var h = +new Date() - o;
          n && clearTimeout(n),
            h > t || !s.enableThrottle || a ? l() : (n = setTimeout(l, t - h));
        };
      }
      function y() {
      ...
      function _(t) {
        return (t = s[t]) ? (t.apply(i, [].slice.call(arguments, 1)), !0) : !1;
      }
      var w = 0,
        x = -1,
        k = -1,
    ...
    function s(s, r) {
      ...
      return (
        ...
        (a.loadAll = function () {
          return h.e && h.e({ all: !0 }, !0), a;
        }),
        (a.destroy = function () {
          return (
            n(l.appendScroll).off("." + c, h.e), n(t).off("." + c), (h = {}), e
          );
        }),
        i(a, l, s, h, c),
        l.chainable ? s : a
      ...
      (n.Lazy = n.lazy = function (t, i, o) {
        if ((n.isFunction(i) && ((o = i), (i = [])), n.isFunction(o))) {
          ...
          for (
            ...
            (r[t[l]] === e || n.isFunction(r[t[l]])) && (r[t[l]] = o);
          for (var c = 0, u = i.length; u > c; c++) a[i[c]] = t[0];
        }
      }),
      (s.prototype.config = {
        name: "lazy",
        ...
        imageBase: null,
        defaultImage:
          "data:image/gif;base64,R0lGODlhAQABAIAAAP///wGV9Jm2u7rmsCe65wKzPTw5jtS38n2tVEGiOw==",
        placeholder: null,
        delay: -1,
        combined: !1,
        attribute: "data-src",
  ...
  (function (t) {
    ...
    (t.cleanData = (function (e) {
      ...
      (t.widget.extend = function (e) {
        for (
          var i, s, n = h.call(arguments, 1), o = 0, r = n.length;
          r > o;
          o++
        )
          for (i in n[o])
          ...
          return (
            ...
            this.each(function () {
              var s,
                ...
                d = i(this, "marginLeft"),
                v = i(this, "marginTop"),
                k = h + d + i(this, "marginRight") + _.width,
                C = c + v + i(this, "marginBottom") + _.height,
                T = t.extend({}, m),
              ...
              "right" === n.my[0]
                ...
                n.using &&
                  (a = function (t) {
                    ...
                    h > p && r(e + i) < p && (u.horizontal = "center"),
                      c > f && r(s + a) < f && (u.vertical = "middle"),
                      (u.important =
                        o(r(e), r(i)) > o(r(s), r(a))
                          ? "horizontal"
                          : "vertical"),
        ...
        (t.ui.position = {
          fit: {
            left: function (t, e) {
              ...
              e.collisionWidth > r
                ? l > 0 && 0 >= h
                  ? ((i = t.left + l + e.collisionWidth - r - n),
                    (t.left += l - i))
                  : (t.left =
                      h > 0 && 0 >= l
                        ? n
                        : l > h
                        ? n + r - e.collisionWidth
                        : n)
                : l > 0
                ? (t.left += l)
                : h > 0
            ...
            top: function (t, e) {
              ...
              e.collisionHeight > r
                ? l > 0 && 0 >= h
                  ? ((i = t.top + l + e.collisionHeight - r - n),
                    (t.top += l - i))
                  : (t.top =
                      h > 0 && 0 >= l
                        ? n
                        : l > h
                        ? n + r - e.collisionHeight
                        : n)
                : l > 0
                ? (t.top += l)
                : h > 0
        ...
        function i(e, i) {
          ...
          for (s in i)
            (o = i[s]),
              e[s] !== o &&
                (n[s] ||
                  ((t.fx.step[s] || !isNaN(parseFloat(o))) && (r[s] = o)));
          return r;
        }
      ...
      t.effects.define("blind", "hide", function (e, i) {
        ...
        t.effects.define("explode", "hide", function (e, i) {
          ...
          var o,
            ...
            y = [];
          for (o = 0; u > o; o++)
            for (l = m.top + o * b, c = o - (u - 1) / 2, r = 0; d > r; r++)
              (a = m.left + r * v),
                (h = r - (d - 1) / 2),
                p
                  .clone()
      ...
      return "area" === h
        ? ((n = i.parentNode),
          ...
          i.href && o && "map" === n.nodeName.toLowerCase()
            ? ((r = t("img[usemap='#" + o + "']")),
              r.length > 0 && r.is(":visible"))
            : !1)
        : (/^(input|select|textarea|button|object)$/.test(h)
            ? ((a = !i.disabled),
              a && ((l = t(i).closest("fieldset")[0]), l && (a = !l.disabled)))
            : (a = "a" === h ? i.href || s : s),
        ...
        _eventHandler: function (e) {
          ...
          e.preventDefault(),
            (a && !n.collapsible) ||
              ...
              ((n.active = l ? !1 : this.headers.index(r)),
              (this.active = a ? t() : r),
              this._toggle(u),
              this._removeClass(
                o,
        ...
        if (
          ...
          (s = t.datepicker._getInst(e)),
            ...
            o !== !1 &&
              ...
              t.datepicker._updateDatepicker(s),
              (l = t.datepicker._checkOffset(s, l, a)),
              s.dpDiv.css({
                position:
        ...
        for (
          t.drawMonth = Z,
            ...
            i = U
              ? this.formatDate(
                  i,
                  this._daylightSavingAdjust(new Date(te, Z - K, 1)),
          ...
          for (k = "", this.maxRows = 4, C = 0; C < Y[1]; C++) {
            if (
              ...
              if (((D += "<div class='ui-datepicker-group"), Y[1] > 1))
                switch (C) {
                  case 0:
            ...
            for (
              D +=
                ...
                S +
                "'>" +
                (/all|left/.test(S) && 0 === x ? (R ? o : s) : "") +
                (/all|right/.test(S) && 0 === x ? (R ? s : o) : "") +
            ...
            for (
              D += $ + "</tr></thead><tbody>",
                ...
                A = (this._getFirstDayOfMonth(te, Z) - c + 7) % 7,
                E = Math.ceil((A + I) / 7),
                O = X ? (this.maxRows > E ? this.maxRows : E) : E,
                this.maxRows = O,
                M = this._daylightSavingAdjust(new Date(te, Z, 1 - A)),
                N = 0;
              O > N;
              N++
            ) {
              for (
                ...
                (z = m ? m.apply(t.input ? t.input[0] : null, [M]) : [!0, ""]),
                  (L = M.getMonth() !== Z),
                  (W = (L && !b) || !z[0] || (Q && Q > M) || (J && M > J)),
                  (H +=
                    "<td class='" +
                    ...
                    ((M.getTime() === T.getTime() &&
                      Z === t.selectedMonth &&
                      t._keyEvent) ||
                    (y.getTime() === M.getTime() && y.getTime() === T.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (W
          ...
          t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              var s,
                n,
                o,
                r = b(e, this, this.options.tolerance, i),
                a =
                  !r && this.isover
                    ? "isout"
                    : r && !this.isover
      ...
      t.widget("ui.slider", t.ui.mouse, {
        ...
        _slide: function (t, e, i) {
          ...
          this._hasMultipleValues() &&
            ...
            (r[e] = i)),
            i !== o &&
              ((s = this._trigger("slide", t, this._uiHash(e, i, r))),
              s !== !1 &&
                (this._hasMultipleValues()
                  ? this.values(e, i)
                  : this.value(i)));
    ...
    t.widget("ui.spinner", {
      ...
      value: function (t) {
        return arguments.length
          ? (a(this._value).call(this, t), void 0)
    ...
    t.widget("ui.tabs", {
      ...
      _eventHandler: function (e) {
        var i = this.options,
          ...
          c = { oldTab: s, oldPanel: h, newTab: a ? t() : o, newPanel: l };
        e.preventDefault(),
...
+(function (t) {
            ...
            this.$element.on(
              ...
              t.proxy(function (t) {
                return this.ignoreBackdropClick
                  ? ((this.ignoreBackdropClick = !1), void 0)
    ...
    (i.VERSION = "3.3.7"),
          ...
          if (h) {
            ...
            (a =
              "bottom" == a && c.bottom + d > f.bottom
                ...
                : "top" == a && c.top - d < f.top
                ? "bottom"
                : "right" == a && c.right + u > f.width
                ? "left"
                : "left" == a && c.left - u < f.left
                ? "right"
                : a),
      ...
      (i.prototype.getViewportAdjustedDelta = function (t, e, i, s) {
        ...
        if (/right|left/.test(t)) {
          ...
          h < r.left
            ? (n.left = r.left - h)
            : c > r.right && (n.left = r.left + r.width - c);
        }
        return n;
      }),
  ...
  (function (t) {
        ...
        for (
          ...
          if (
            ...
            var f =
              ...
              l;
            if (
              (0 > f ? (f += u.topSpacing) : (f = u.topSpacing),
              u.currentTop !== f)
            ) {
              var g;
              u.getWidthFrom
                ? (g = t(u.getWidthFrom).width() || null)
                : u.widthFromWrapper && (g = u.stickyWrapper.width()),
                null == g && (g = u.stickyElement.width()),
                u.stickyElement
                  .css("width", g)
                  .css("position", "fixed")
                  .css("top", f)
      ...
      h = function () {
        ...
        for (var e = 0, i = r.length; i > e; e++) {
          var s = r[e],
            o = null;
          s.getWidthFrom
            ? s.responsiveWidth && (o = t(s.getWidthFrom).width())
            : s.widthFromWrapper && (o = s.stickyWrapper.width()),
            null != o && s.stickyElement.css("width", o);
        }
      },
      c = {
        init: function (e) {
          return this.each(function () {
            var i = t.extend({}, s, e),
              n = t(this),
              o = n.attr("id"),
              a = o ? o + "-" + s.wrapperClassName : s.wrapperClassName,
              l = t("<div></div>").attr("id", a).addClass(i.wrapperClassName);
            n.wrapAll(function () {
              return 0 == t(this).parent("#" + a).length ? l : void 0;
            });
            var h = n.parent();
            i.center &&
              h.css({
        ...
        unstick: function () {
          return this.each(function () {
            for (var e = this, s = t(e), n = -1, o = r.length; o-- > 0; )
              r[o].stickyElement.get(0) === e && (i.call(r, o, 1), (n = o));
            -1 !== n &&
              (s.unwrap(),
              s.css({
                width: "",
    ...
    window.addEventListener
      ...
      : window.attachEvent &&
        (window.attachEvent("onscroll", l), window.attachEvent("onresize", h)),
      (t.fn.sticky = function (i) {
        return c[i]
          ? c[i].apply(this, e.call(arguments, 1))
          : "object" != typeof i && i
    ...
    (e = (function () {
      ...
      (e.prototype.getSlideCount = function () {
        ...
        return (
          ...
          n.options.swipeToSlide === !0
            ? (n.$slideTrack.find(".slick-slide").each(function (e, o) {
                return o.offsetLeft - s + t(o).outerWidth() / 2 >
                  -1 * n.swipeLeft
                  ? ((i = o), !1)
                  : void 0;
              }),
              (e =
                Math.abs(t(i).attr("data-slick-index") - n.currentSlide) || 1))
        ...
        e.$slides
          ...
          null !== e.$dots &&
            ...
            e.$dots
              ...
              .end());
        for (var n = e.currentSlide, o = n + e.options.slidesToShow; o > n; n++)
      ...
      (e.prototype.lazyLoad = function () {
        ...
        if (
          (r.options.centerMode === !0
            ? r.options.infinite === !0
              ...
              : ((n = Math.max(
                ...
                (o = 2 + (r.options.slidesToShow / 2 + 1) + r.currentSlide))
          ...
          for (
            var a = n - 1, l = o, h = r.$slider.find(".slick-slide"), c = 0;
            c < r.options.slidesToScroll;
            c++
          )
            0 > a && (a = r.slideCount - 1),
              (i = i.add(h.eq(a))),
              (i = i.add(h.eq(l))),
              a--,
              l++;
      ...
      (e.prototype.selectHandler = function (e) {
        ...
        return (
          ...
          i.slideCount <= i.options.slidesToShow
            ? (i.slideHandler(n, !1, !0), void 0)
            : (i.slideHandler(n), void 0)
        );
      }),
      (e.prototype.slideHandler = function (t, e, i) {
        ...
        return (
          (e = e || !1),
          (h.animating === !0 && h.options.waitForAnimate === !0) ||
          (h.options.fade === !0 && h.currentSlide === t)
            ? void 0
            : (e === !1 && h.asNavFor(t),
              (s = t),
              (l = h.getLeft(s)),
              ...
              h.options.centerMode === !1 &&
              (0 > t || t > h.getDotCount() * h.options.slidesToScroll)
                ? (h.options.fade === !1 &&
                    ((s = h.currentSlide),
                    i !== !0 && h.slideCount > h.options.slidesToShow
                  ...
                  void 0)
                : h.options.infinite === !1 &&
                  h.options.centerMode === !0 &&
                  (0 > t || t > h.slideCount - h.options.slidesToScroll)
                ? (h.options.fade === !1 &&
                    ((s = h.currentSlide),
                    i !== !0 && h.slideCount > h.options.slidesToShow
                      ? h.animateSlide(r, function () {
                  ...
                  (n =
                    0 > s
                      ? h.slideCount % h.options.slidesToScroll !== 0
                        ? h.slideCount -
                          (h.slideCount % h.options.slidesToScroll)
                        : h.slideCount + s
                      : s >= h.slideCount
                      ? h.slideCount % h.options.slidesToScroll !== 0
                        ? 0
  ...
  (function () {
    ...
    function t(t, i) {
      ...
      return (
        ...
        (this.$items = this.s.dynamic
          ...
          : "" !== this.s.selector
          ? this.s.selectWithin
            ? $(this.s.selectWithin).find(this.s.selector)
            : this.$el.find($(this.s.selector))
          : this.$el.children()),
        (this.$slide = ""),
        (this.$outer = ""),
        this.init(),
    ...
    (t.prototype.init = function () {
      ...
      e.indexOf("lg=" + this.s.galleryId) > 0 &&
        ...
        t.s.dynamic
          ? (t.$el.trigger("onBeforeOpen.lg"),
            ...
            $("body").hasClass("lg-on") ||
              setTimeout(function () {
                t.build(t.index), $("body").addClass("lg-on");
              }))
      ...
      (t.prototype.build = function (t) {
        var e = this;
        e.structure(),
          $.each($.fn.lightGallery.modules, function (t) {
            e.modules[t] = new $.fn.lightGallery.modules[t](e.el);
          }),
          e.slide(t, !1, !1, !1),
      ...
      (t.prototype.loadContent = function (t, e, i) {
        var s,
          ...
          u = function (t) {
            ...
            for (var r = $(window).width(), a = 0; a < e.length; a++)
        ...
        if (h.s.dynamic) {
          if (
            (h.s.dynamicEl[t].poster &&
              ((c = !0), (o = h.s.dynamicEl[t].poster)),
            (l = h.s.dynamicEl[t].html),
            (n = h.s.dynamicEl[t].src),
            h.s.dynamicEl[t].responsive)
          ) {
            var d = h.s.dynamicEl[t].responsive.split(",");
            u(d);
          }
        ...
        var f = !1;
        h.s.dynamic
          ? h.s.dynamicEl[t].iframe && (f = !0)
          : "true" === h.$items.eq(t).attr("data-iframe") && (f = !0);
        var g = h.isVideo(n, t);
          ...
          if (f)
            ...
            g
              ? (h.$slide
                ...
                h.$el.trigger("hasVideo.lg", [t, n, l]))
              : h.$slide
                  .eq(t)
                  .prepend(
        ...
        h.$slide
          ...
          .on("load.lg error.lg", function () {
            var e = 0;
            i && !$("body").hasClass("lg-from-hash") && (e = i),
              setTimeout(function () {
                h.$slide.eq(t).addClass("lg-complete"),
                  h.$el.trigger("onSlideItemLoad.lg", [t, i || 0]);
              }, e);
          }),
          g && g.html5 && !c && h.$slide.eq(t).addClass("lg-complete"),
          e === !0 &&
          ...
          if (!o.lgBusy) {
            ...
            if (
              ...
              r > 2
                ...
                : ((h = 0), (c = 1)),
                "prev" === s
                  ? o.$slide.eq(c).addClass("lg-next-slide")
                  : o.$slide.eq(h).addClass("lg-prev-slide"),
            ...
            o.lGalleryOn
              ? (setTimeout(function () {
                ...
                setTimeout(function () {
                  (o.lgBusy = !1),
                    o.$el.trigger("onAfterSlide.lg", [n, t, e, i]);
                }, this.s.speed))
              : (o.loadContent(t, !0, o.s.backdropDuration),
                (o.lgBusy = !1),
                o.$el.trigger("onAfterSlide.lg", [n, t, e, i])),
              (o.lGalleryOn = !0),
              this.s.counter && $("#lg-counter-current").text(t + 1);
          }
          o.index = t;
        }
      }),
      ...
      (t.prototype.setTranslate = function (t, e, i) {
        this.s.useLeft
          ? t.css("left", e)
          : t.css({ transform: "translate3d(" + e + "px, " + i + "px, 0px)" });
      }),
      ...
      (t.prototype.enableDrag = function () {
        ...
        t.s.enableDrag &&
          ...
          $(window).on("mousemove.lg", function (o) {
            s &&
              ((n = !0),
              (i = o.pageX),
              t.touchMove(e, i),
          ...
          $(window).on("mouseup.lg", function (o) {
            n
              ? ((n = !1), t.touchEnd(i - e), t.$el.trigger("onDragend.lg"))
              : ($(o.target).hasClass("lg-object") ||
                  $(o.target).hasClass("lg-video-play")) &&
                t.$el.trigger("onSlideClick.lg"),
              s &&
                ((s = !1),
        ...
        this.$outer.find(".lg-close").on("click.lg", function () {
          ...
          t.s.closable &&
            (t.$outer.on("mousedown.lg", function (t) {
              e =
                $(t.target).is(".lg-outer") ||
                $(t.target).is(".lg-item ") ||
                $(t.target).is(".lg-img-wrap")
                  ? !0
                  : !1;
            }),
            ...
            t.$outer.on("mouseup.lg", function (i) {
              ($(i.target).is(".lg-outer") ||
                $(i.target).is(".lg-item ") ||
                ($(i.target).is(".lg-img-wrap") && e)) &&
      ...
      (t.prototype.destroy = function (t) {
        ...
        t ||
          ...
          $(window).scrollTop(e.prevScrollTop)),
          t &&
            (e.s.dynamic || this.$items.off("click.lg click.lgcustom"),
            $.removeData(e.el, "lightGallery")),
          this.$el.off(".lg.tm"),
          $.each($.fn.lightGallery.modules, function (t) {
      ...
      ($.fn.lightGallery = function (e) {
        return this.each(function () {
          ...
          else $.data(this, "lightGallery", new t(this, e));
        });
      }),
  ...
  (function (t, e, i, s) {
    "use strict";
    var n = t.fn.twbsPagination,
      o = function (e, i) {
        if (
          ((this.$element = t(e)),
          (this.options = t.extend({}, t.fn.twbsPagination.defaults, i)),
        ...
        if ("UL" === s) this.$listContainer = this.$element;
          ...
          n.each(function () {
            var e = t("<ul></ul>");
            t(this).append(e), o.push(e[0]);
          }),
            (this.$listContainer = o),
            (this.$element = o);
        }
        return (
    ...
    (o.prototype = {
      ...
      show: function (t) {
        if (1 > t || t > this.options.totalPages)
      ...
      disable: function () {
        ...
        this.$listContainer.off("click").on("click", "li", function (t) {
          ...
          this.$listContainer.children().each(function () {
            var i = t(this);
            i.hasClass(e.options.activeClass) ||
              t(this).addClass(e.options.disabledClass);
          });
      },
      buildListItems: function (t) {
        var e = [];
        if (
          (this.options.first && e.push(this.buildItem("first", 1)),
          this.options.prev)
        ) {
          var i =
            t.currentPage > 1
              ...
              : 1;
          e.push(this.buildItem("prev", i));
        }
        for (var s = 0; s < t.numeric.length; s++)
          e.push(this.buildItem("page", t.numeric[s]));
        if (this.options.next) {
          var n =
            t.currentPage < this.options.totalPages
              ...
              ? 1
              : this.options.totalPages;
          e.push(this.buildItem("next", n));
        }
        return (
          this.options.last &&
            e.push(this.buildItem("last", this.options.totalPages)),
          e
        );
      },
      buildItem: function (e, i) {
        var s = t("<li></li>"),
          n = t("<a></a>"),
          o = this.options[e] ? this.makeText(this.options[e], i) : i;
        return (
          s.addClass(this.options[e + "Class"]),
          s.data("page", i),
          s.data("page-type", e),
          s.append(
            n
              .attr("href", this.makeHref(i))
      ...
      getPages: function (t) {
        var e = [],
          ...
          s = t - i + 1 - (this.options.visiblePages % 2),
          n = t + i,
          o = this.options.visiblePages;
        o > this.options.totalPages && (o = this.options.totalPages),
          0 >= s && ((s = 1), (n = o)),
          n > this.options.totalPages &&
            ((s = this.options.totalPages - o + 1),
            (n = this.options.totalPages));
        for (var r = s; n >= r; ) e.push(r), r++;
        return { currentPage: t, numeric: e };
      },
      render: function (e) {
        var i = this;
        this.$listContainer.children().remove();
        var s = this.buildListItems(e);
        t.each(s, function (t, e) {
          i.$listContainer.append(e);
        }),
          this.$listContainer.children().each(function () {
            var s = t(this),
              n = s.data("page-type");
            switch (n) {
              case "page":
                s.data("page") === e.currentPage &&
                  s.addClass(i.options.activeClass);
                break;
              case "first":
                s.toggleClass(i.options.disabledClass, 1 === e.currentPage);
                break;
              case "last":
                s.toggleClass(
                  i.options.disabledClass,
                  e.currentPage === i.options.totalPages
                );
                break;
              case "prev":
                s.toggleClass(
                  i.options.disabledClass,
                  !i.options.loop && 1 === e.currentPage
                );
                break;
              case "next":
                s.toggleClass(
                  i.options.disabledClass,
                  !i.options.loop && e.currentPage === i.options.totalPages
                );
            }
          });
      },
      setupEvents: function () {
        ...
        this.$listContainer.off("click").on("click", "li", function (i) {
          var s = t(this);
          return s.hasClass(e.options.disabledClass) ||
            s.hasClass(e.options.activeClass)
            ? !1
            : (!e.options.href && i.preventDefault(),
      ...
      makeText: function (t, e) {
        return t
          .replace(this.options.pageVariable, e)
      ...
      getPageFromQueryString: function (t) {
        var e = this.getSearchString(t),
          ...
          s = i.exec(e);
        return s && s[2]
          ? ((s = decodeURIComponent(s[2])),
            (s = parseInt(s)),
            isNaN(s) ? null : s)
          : null;
      },
      generateQueryString: function (t, e) {
        var i = this.getSearchString(e),
          s = new RegExp(this.options.pageVariable + "=*[^&#]*");
        return i ? "?" + i.replace(s, this.options.pageVariable + "=" + t) : "";
      },
      getSearchString: function (t) {
        var i = t || e.location.search;
      ...
      (t.fn.twbsPagination = function (e) {
        var i,
          ...
          r = t(this),
          a = r.data("twbs-pagination"),
          l = "object" == typeof e ? e : {};
        return (
          a || r.data("twbs-pagination", (a = new o(this, l))),
          "string" == typeof e && (i = a[e].apply(a, n)),
          i === s ? r : i
        );
      }),
      ...
      (t.fn.twbsPagination.Constructor = o),
      (t.fn.twbsPagination.noConflict = function () {
        return (t.fn.twbsPagination = n), this;
      }),
      (t.fn.twbsPagination.version = "1.4.2");
  })(window.jQuery, window, document),
  $(document).ready(function () {
    console.log("hutom.com!"),
      $(".caret").click(function (t) {
        t.preventDefault(), $(".caret").closest(".dropdown-menu").toggle();
      });
    var t,
      e,
      i = 1024,
    ...
    i > s
      ? ((t = 40), (e = 50), (hnprime = 25), (pnprime = 50))
      : ((t = 100), (e = 200), (hnprime = 25), (pnprime = 80)),
      $(".hprime").each(function () {
        ...
        if (i > t) {
          ...
          (this.innerText = s),
            $(this).append('<span class="more-text">...</span>');
        }
      }),
      $(".pprime").each(function () {
      ...
      $(".hnprime").each(function () {
        var t = this.innerText,
          e = t.length;
        if (e > hnprime) {
          var i = t.substring(0, hnprime);
          (this.innerText = i),
            $(this).append('<span class="more-text">...</span>');
        }
      }),
      $(".pnprime").each(function () {
        var t = this.innerText,
          e = t.length;
        if (e > pnprime) {
          var i = t.substring(0, pnprime);
          (this.innerText = i),
            $(this).append('<span class="more-text">...</span>');
        }
      }),
      ...
      $(".more-jobs a").click(function (t) {
        t.preventDefault();
        var e = $(this);
        e.toggleClass("more-jobs a"),
          e.hasClass("more-jobs a")
            ? e.text("View less jobs")
            : e.text("View more jobs");
      }),
      ...
      $("#sticker").sticky({ topSpacing: 0, left: !0 }),
      $(".share-image").on("click", function () {
        $("#shairs-link").toggle("slow");
      });
    for (
      var n = document.querySelectorAll(".youtube"),
        o = document.querySelectorAll(".vid-img-box"),
        r = 0;
      r < n.length;
      r++
    ) {
      var a = n[r].getAttribute("data-embed").trim(),
        l = a.split(/"/)[1],
        h = l.lastIndexOf("/"),
        c = l.substring(h + 1),
        u = "";
      u =
        void 0 == c || "" == c
          ...
          : "https://i.ytimg.com/vi/" + c + "/hqdefault.jpg";
      var d = new Image();
      d.src = u;
      var p = new Image();
      (p.src = u),
        (p.className = "img-responsive"),
        d.addEventListener(
          "load",
          (function () {
            n[r].appendChild(d), o[r].insertBefore(p, o[r].childNodes[0]);
          })(r)
        ),
        n[r].addEventListener("click", function () {
          var t = this.getAttribute("data-embed");
      ...
      if (m > v) {
        for (var y, _, w, x = 1; b >= x; x++) {
          for (
            ...
            g.eq(_).appendTo(y), _++;
          f.append(y), 1 === x && (w = $("#item-page-" + x, f));
        }
        $("#pagination").twbsPagination({
          ...
          onPageClick: function (t, e) {
            w.hide(500),
              (w = $("#item-page-" + e, f)),
              w.show(1e3),
              $(".sub-category-recent-next").animate(
    ...
    $("#comment-form").on("submit", function (t) {
      t.preventDefault();
      var e = new FormData(this);
      $.ajax({
        url: base_url + "member/comment",
        data: e,
        type: "POST",
        contentType: !1,
        processData: !1,
        success: function (t) {
          1 == t
            ? (alert("Comment add successfully."), location.reload())
            : (console.log(t),
              alert("Comment add failed please try again\r\n"));
        },
      });
    }),
      $("#vote").submit(function (t) {
        t.preventDefault();
        var e = new FormData(this);
        $.ajax({
          url: base_url + "vote",
          ...
          processData: !1,
          success: function (t) {
            "Thank you for voting." == t || "Your vote already accepted." == t
              ? ($(".modal-body-vote").html(t),
                $("#empModal").modal("show"),
                $("#md-cls1").click(function () {
                  location.reload();
                }),
              ...
              : ($(".modal-body-vote").html(
                  '<a href=base_url + "member/login">' + t + "</a>"
                ),
                $("#empModal").modal("show"));
          },
        });
      }),
      $("#post-article").submit(function (t) {
        t.preventDefault();
        var e = new FormData(this);
        $.ajax({
          ...
          success: function (t) {
            "Thank You." == t
              ? ($("#post-result").html(t),
                window.location.reload(base_url + "#foram-form-box"))
              : $("#post-result").html(t);
          },
        });
      }),
      $(".mail-to").click(function () {
        var t =
          '<form action="#" id="send-mail" method="POST"><div class="form-group"><label for="email">Your Email address:</label><input type="email" class="form-control" name="from_email" required></div><div class="form-group"><label for="">Receiver Email address:</label><input type="email" class="form-control" name="to_email" required></div><div class="form-group"><label for="subject">Title:</label><input type="text" class="form-control" name="subject"></div><div class="form-group"><label for="body">Description:</label><textarea rows="8" class="form-control" name="description"></textarea></div><button type="submit" class="btn btn-default">Submit</button></form>';
        $(".modal-body-mail").html(t);
        var e = String($(".single-page-news-title").html()).trim(),
          i = String($(".single-page-news-description p").html()).trim();
        $('input[name="subject"]').val(e),
          $('textarea[name="description"]').val(i),
          $("#mail").modal("show"),
          $("#send-mail").submit(function (t) {
            t.preventDefault();
            var e = new FormData(this);
            $.ajax({
              url: base_url + "share",
              ...
              processData: !1,
              success: function (t) {
                "Email sent successfully" == t && $(".modal-body-mail").html(t);
              },
            });
          });
      }),
      $("#serches").autocomplete({
        ...
        select: function (t, e) {
          t.preventDefault(),
            console.log(e.item),
            $("#serches").val(e.item.label);
          var i = e.item.value;
          $("#n-link").attr("href", base_url + "details/" + i);
        },
      });
    var k = 220;
    $("#message").after('<span id="count" class="counter"></span>'),
      $("#count").html(k + " of " + k),
      $("#message").attr("maxlength", k),
      $("#message").on("keydown", function (t) {
        var e = $("#message").val().length;
        e >= k && 8 != t.keyCode
          ? t.preventDefault()
          : k >= e && 8 == t.keyCode
          ? k >= e && 0 != e
            ? $("#count").html(k - e + 1 + " of " + k)
            : 0 == e && $("#count").html(k - e + " of " + k)
          : $("#count").html(k - e - 1 + " of " + k);
      }),
      $(".subscriber-form").submit(function (t) {
        t.preventDefault();
        var e = new FormData(this);
        $.ajax({
          url: base_url + "subscribe/make",
          data: e,
          type: "POST",
          contentType: !1,
          processData: !1,
          success: function (t) {
            "1" == t
              ? $("#result").html(
                  'Thank you for your subscribtion. <a href=base_url + "">Go to home.</a>'
                )
              : "2" == t
              ? $("#result").html(
                  'Already subscribe. <a href=base_url + "">Go to home.</a>'
                )
              : (alert("something is wrong try again."), location.reload());
          },
        });
      }),
      $(".email").click(function (t) {
        t.preventDefault(), $(".register").show(), $(".login").hide();
      }),
      $("#back-login").click(function (t) {
        t.preventDefault(), $(".login").show(), $(".register").hide();
      }),
      $("#login").on("submit", function (t) {
        t.preventDefault();
        var e = new FormData(this);
        $.ajax({
          url: base_url + "member/email-login",
          data: e,
          type: "POST",
          contentType: !1,
          processData: !1,
          success: function (t) {
            1 == t
              ? ($(".ajax-result").html("Login success."),
                setTimeout(function () {
      ...
      $("#register").on("submit", function (t) {
        t.preventDefault();
        var e = new FormData(this);
        $.ajax({
          url: base_url + "member/email-register",
          data: e,
          type: "POST",
          contentType: !1,
          processData: !1,
      ...
      $("#google-register").on("submit", function (t) {
        t.preventDefault();
        var e = new FormData(this);
        $.ajax({
          url: base_url + "member/add-google-user",
          data: e,
          type: "POST",
          contentType: !1,
          processData: !1,
          success: function (t) {
            "Registration successful, please login." == t
              ? ($(".ajax-result").html(t),
                setTimeout(function () {
                  location.href = base_url + "member/login";
                }, 1e3))
              : ($(".ajax-result").html(
                  "Already exists or something is wrong please try again."
                ),
                setTimeout(function () {
                  location.href = base_url + "member/login";
                }, 1e3));
      ...
      $(".albam-wrap").click(function () {
        var t = new FormData();
        t.append("cat_name", $(this).attr("dtmbd")),
          (window.showGal = !1),
          $.ajax({
            url: base_url + "photos/get-photo",
            data: t,
            type: "POST",
            contentType: !1,
            processData: !1,
            success: function (t) {
              (window.result = t),
                (window.jshoData = JSON.parse(window.result)),
                (window.output = []);
              for (var e = 0; e < window.jshoData.length; e++)
                (window.tmp = {
                  src:
                    base_url + "image_upload/images/" + window.jshoData[e].name,
                  thumb:
                    base_url + "image_upload/images/" + window.jshoData[e].name,
                  subHtml: window.jshoData[e].description,
                }),
                  window.output.push(window.tmp);
              window.showGal = !0;
            },
            complete: function () {
              $(this).lightGallery({
                dynamic: !0,
                dynamicEl: window.output,
              });
            },
          });
      });
      ...
      if (m > v) {
        for (var y, _, T, w, x = 1; b >= x; x++) {
          for (
            ...
            g.eq(_).appendTo(y), _++;
          C.append(y), 1 === x && (w = $("#item-page-" + x, C));
        }
        $("#pagination").twbsPagination({
          totalPages: b,
          visiblePages: 5,
...
$("#passwordReset").on("submit", function (e) {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/member/password-reset",
    ...
    success: function (data) {
      if (data == "1") {
        ...
        $(".ajax-result").html("Invalid Email ID");
      }
    },
  });
});
$("#updatePassword").on("submit", function (e) {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/member/update-password",
    data: form.serialize(), // serializes the form's elements.
    success: function (data) {
      if (data == "1") {
        $(".ajax-result").html("Password updated successfully");
        window.location = base_url + "member/login";
      } else {
        $(".ajax-result").html("Password does not match");
      }
    },
  });
});
...
//var cur  = $(".inpf").val();
var monthinr = document.getElementById("monthinr");
var yearinr = document.getElementById("yearinr");
var onetimeinr = document.getElementById("onetimeinr");
var monthusd = document.getElementById("monthusd");
var yearusd = document.getElementById("yearusd");
var onetimeusd = document.getElementById("onetimeusd");

var wrapper = $("#amountwrapper"); //Input field wrapper
var nmbfield =
  '<input type="number" name="amount" class="inpp mainprice" step="50" value="1" min="1">';

var monthinrfield =
  '<select class="inpfs" id="monthinr" name="amount"><option value="100">100</option><option value="150">150</option><option value="200">200</option><option value="other">other</option></select>';
var yearinrfield =
  '<select class="inpfs" id="yearinr" name="amount"><option value="1000">1000</option><option value="1500">1500</option><option value="2000">2000</option><option value="other">other</option></select>';

var onetimeinrfield =
  '<select class="inpfs" id="onetimeinr" name="amount"><option value="1000">1000</option><option value="2000">2000</option><option value="5000">5000</option><option value="10000">10000</option><option value="other">other</option></select>';
var monthusdfield =
  '<select class="inpfs" id="monthusd" name="amount"><option value="1.99">1.99</option><option value="4.99">4.99</option><option value="other">other</option></select>';

var yearusdfield =
  '<select class="inpfs" id="yearusd" name="amount"><option value="19.99">19.99</option><option value="49.99">49.99</option><option value="other">other</option></select>';

var onetimeusdfield =
  '<select class="inpfs" id="onetimeusd" name="amount"><option value="50">50</option><option value="100">100</option><option value="200">200</option><option value="500">500</option><option value="other">other</option></select>';
$("#monthinr").change(function () {
  if ($("#monthinr").val() === "other") {
    // alert($("#monthinr").val());
    $(wrapper).html(nmbfield);
  }
});
$(".btnmonthly").click(function () {
  if ($(".inpf").val() === "INR") {
    ...
    $(".btnyerly").removeClass("active");
    $(".btnot").removeClass("active");
    $(monthinr).remove();
    $(wrapper).html(monthinrfield);
    $(monthusd).remove();
    $(yearinr).remove();
    $(onetimeinr).remove();
    $(yearusd).remove();
    $(onetimeusd).remove();
    // $('.mainprice').val('100');
    $(".inpfs").change(function () {
      if ($(".inpfs").val() === "other") {
        $(wrapper).html(nmbfield);
      }
    });
  } else if ($(".inpf").val() === "USD") {
    // alert($(".inpf").val());
    $(this).addClass("active");
    $(".btnyerly").removeClass("active");
    $(".btnot").removeClass("active");
...
$("select.inpf").change(function () {
  if ($(".inpf").val() === "INR" && $("a.btnbtn.active").html() === "Monthly") {
    // alert($("a.btnbtn.active").html());
    // $('.mainprice').val('100');
    $(monthinr).remove();
    $(wrapper).html(monthinrfield);
    $(monthusd).remove();
...
$("#cookie_Accept").click(function () {
  $.ajax({
    type: "POST",
    url: base_url + "/member/cookie-policy",
    success: function (data) {
      $(".conscent_cookie").attr("style", "bottom:-1000px;");
    },
  });
});
...
setTimeout(function () {
  $(".conscent_cookie").attr("style", "bottom:0px;");
}, 2000);
...
function codeAddress() {
  ...
  // var ogimg = document.getElementById("ogimage").src ;
  // alert(ogimg);
}
window.onload = codeAddress;


$("#save-graphiti").submit(function(e){
    e.preventDefault();
    $.ajax({
         url: site_url+"/article/useraddgraphiti",
       type: "POST",
